...
function poseLounge(r, t) {
  ...
  r.spine.rotation.set(0.4 + breath, 0, 0);
  r.chest.rotation.set(0.22 + breath * 0.55, 0, 0);
  r.neck.rotation.set(0.16, 0, 0);
  r.head.rotation.set(-0.1 + breath * 0.25, 0, 0);
  r.hipL.rotation.set(0.04, 0, -0.05);
  r.hipR.rotation.set(0.04, 0, 0.05);
  r.kneeL.rotation.set(-0.08, 0, 0);
  r.kneeR.rotation.set(-0.08, 0, 0);
  r.footL.rotation.set(0.06, 0, 0);
  r.footR.rotation.set(0.06, 0, 0);
  r.shoulderL.rotation.set(0.18, 0.12, -0.8);
  r.shoulderR.rotation.set(0.18, -0.12, 0.8);
