...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:di,depthTest:!1,depthWrite:!1})}function Bh(){return new _n({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Gc(),fragmentShader:`
		...
		`,blending:di,depthTest:!1,depthWrite:!1})}function Hh(){return new _n({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Gc(),fragmentShader:`
	...
	`}function ox(n){let t=new WeakMap,e=null;function i(a){if(a&&a.isTexture){let c=a.mapping,l=c===Za||c===Ka,h=c===Ms||c===Es;if(l||h)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let u=t.get(a);return e===null&&(e=new Mo(n)),u=l?e.fromEquirectangular(a,u):e.fromCubemap(a,u),t.set(a,u),u.texture}else{if(t.has(a))return t.get(a).texture;{let u=a.image;if(l&&u&&u.height>0||h&&u&&s(u)){e===null&&(e=new Mo(n));let d=l?e.fromEquirectangular(a):e.fromCubemap(a);return t.set(a,d),a.addEventListener("dispose",r),d.texture}else return null}}}return a}function s(a){let c=0,l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function r(a){let c=a.target;c.removeEventListener("dispose",r);let l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:i,dispose:o}}function ax(n){let t={};function e(i){if(t[i]!==void 0)return t[i];let s;switch(i){case"WEBGL_depth_texture":s=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=n.getExtension(i)}return t[i]=s,s}return{has:function(i){return e(i)!==null},init:function(i){i.isWebGL2?(e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance")):(e("WEBGL_depth_texture"),e("OES_texture_float"),e("OES_texture_half_float"),e("OES_texture_half_float_linear"),e("OES_standard_derivatives"),e("OES_element_index_uint"),e("OES_vertex_array_object"),e("ANGLE_instanced_arrays")),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture")},get:function(i){let s=e(i);return s===null&&console.warn("THREE.WebGLRenderer: "+i+" extension not supported."),s}}}function cx(n,t,e,i){let s={},r=new WeakMap;function o(u){let d=u.target;d.index!==null&&t.remove(d.index);for(let g in d.attributes)t.remove(d.attributes[g]);for(let g in d.morphAttributes){let x=d.morphAttributes[g];for(let m=0,f=x.length;m<f;m++)t.remove(x[m])}d.removeEventListener("dispose",o),delete s[d.id];let p=r.get(d);p&&(t.remove(p),r.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function a(u,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,e.memory.geometries++),d}function c(u){let d=u.attributes;for(let g in d)t.update(d[g],n.ARRAY_BUFFER);let p=u.morphAttributes;for(let g in p){let x=p[g];for(let m=0,f=x.length;m<f;m++)t.update(x[m],n.ARRAY_BUFFER)}}function l(u){let d=[],p=u.index,g=u.attributes.position,x=0;if(p!==null){let y=p.array;x=p.version;for(let _=0,E=y.length;_<E;_+=3){let R=y[_+0],T=y[_+1],A=y[_+2];d.push(R,T,T,A,A,R)}}else if(g!==void 0){let y=g.array;x=g.version;for(let _=0,E=y.length/3-1;_<E;_+=3){let R=_+0,T=_+1,A=_+2;d.push(R,T,T,A,A,R)}}else return;let m=new(Su(d)?_o:xo)(d,1);m.version=x;let f=r.get(u);f&&t.remove(f),r.set(u,m)}function h(u){let d=r.get(u);if(d){let p=u.index;p!==null&&d.version<p.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function lx(n,t,e,i){let s=i.isWebGL2,r;function o(p){r=p}let a,c;function l(p){a=p.type,c=p.bytesPerElement}function h(p,g){n.drawElements(r,g,a,p*c),e.update(g,r,1)}function u(p,g,x){if(x===0)return;let m,f;if(s)m=n,f="drawElementsInstanced";else if(m=t.get("ANGLE_instanced_arrays"),f="drawElementsInstancedANGLE",m===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}m[f](r,g,a,p*c,x),e.update(g,r,x)}function d(p,g,x){if(x===0)return;let m=t.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<x;f++)this.render(p[f]/c,g[f]);else{m.multiDrawElementsWEBGL(r,g,0,a,p,0,x);let f=0;for(let y=0;y<x;y++)f+=g[y];e.update(f,r,1)}}this.setMode=o,this.setIndex=l,this.render=h,this.renderInstances=u,this.renderMultiDraw=d}function hx(n){let t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,o,a){switch(e.calls++,o){case n.TRIANGLES:e.triangles+=a*(r/3);break;case n.LINES:e.lines+=a*(r/2);break;case n.LINE_STRIP:e.lines+=a*(r-1);break;case n.LINE_LOOP:e.lines+=a*r;break;case n.POINTS:e.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:i}}function ux(n,t){return n[0]-t[0]}function dx(n,t){return Math.abs(t[1])-Math.abs(n[1])}function fx(n,t,e){let i={},s=new Float32Array(8),r=new WeakMap,o=new Pe,a=[];for(let l=0;l<8;l++)a[l]=[l,0];function c(l,h,u){let d=l.morphTargetInfluences;if(t.isWebGL2===!0){let p=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,g=p!==void 0?p.length:0,x=r.get(h);if(x===void 0||x.count!==g){let L=function(){q.dispose(),r.delete(h),h.removeEventListener("dispose",L)};x!==void 0&&x.texture.dispose();let y=h.morphAttributes.position!==void 0,_=h.morphAttributes.normal!==void 0,E=h.morphAttributes.color!==void 0,R=h.morphAttributes.position||[],T=h.morphAttributes.normal||[],A=h.morphAttributes.color||[],D=0;y===!0&&(D=1),_===!0&&(D=2),E===!0&&(D=3);let v=h.attributes.position.count*D,b=1;v>t.maxTextureSize&&(b=Math.ceil(v/t.maxTextureSize),v=t.maxTextureSize);let U=new Float32Array(v*b*4*g),q=new po(U,v,b,g);q.type=ui,q.needsUpdate=!0;let Q=D*4;for(let N=0;N<g;N++){let G=R[N],O=T[N],X=A[N],z=v*b*4*N;for(let k=0;k<G.count;k++){let F=k*Q;y===!0&&(o.fromBufferAttribute(G,k),U[z+F+0]=o.x,U[z+F+1]=o.y,U[z+F+2]=o.z,U[z+F+3]=0),_===!0&&(o.fromBufferAttribute(O,k),U[z+F+4]=o.x,U[z+F+5]=o.y,U[z+F+6]=o.z,U[z+F+7]=0),E===!0&&(o.fromBufferAttribute(X,k),U[z+F+8]=o.x,U[z+F+9]=o.y,U[z+F+10]=o.z,U[z+F+11]=X.itemSize===4?o.w:1)}}x={count:g,texture:q,size:new ct(v,b)},r.set(h,x),h.addEventListener("dispose",L)}let m=0;for(let y=0;y<d.length;y++)m+=d[y];let f=h.morphTargetsRelative?1:1-m;u.getUniforms().setValue(n,"morphTargetBaseInfluence",f),u.getUniforms().setValue(n,"morphTargetInfluences",d),u.getUniforms().setValue(n,"morphTargetsTexture",x.texture,e),u.getUniforms().setValue(n,"morphTargetsTextureSize",x.size)}else{let p=d===void 0?0:d.length,g=i[h.id];if(g===void 0||g.length!==p){g=[];for(let _=0;_<p;_++)g[_]=[_,0];i[h.id]=g}for(let _=0;_<p;_++){let E=g[_];E[0]=_,E[1]=d[_]}g.sort(dx);for(let _=0;_<8;_++)_<p&&g[_][1]?(a[_][0]=g[_][0],a[_][1]=g[_][1]):(a[_][0]=Number.MAX_SAFE_INTEGER,a[_][1]=0);a.sort(ux);let x=h.morphAttributes.position,m=h.morphAttributes.normal,f=0;for(let _=0;_<8;_++){let E=a[_],R=E[0],T=E[1];R!==Number.MAX_SAFE_INTEGER&&T?(x&&h.getAttribute("morphTarget"+_)!==x[R]&&h.setAttribute("morphTarget"+_,x[R]),m&&h.getAttribute("morphNormal"+_)!==m[R]&&h.setAttribute("morphNormal"+_,m[R]),s[_]=T,f+=T):(x&&h.hasAttribute("morphTarget"+_)===!0&&h.deleteAttribute("morphTarget"+_),m&&h.hasAttribute("morphNormal"+_)===!0&&h.deleteAttribute("morphNormal"+_),s[_]=0)}let y=h.morphTargetsRelative?1:1-f;u.getUniforms().setValue(n,"morphTargetBaseInfluence",y),u.getUniforms().setValue(n,"morphTargetInfluences",s)}}return{update:c}}function px(n,t,e,i){let s=new WeakMap;function r(c){let l=i.render.frame,h=c.geometry,u=t.get(c,h);if(s.get(u)!==l&&(t.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),s.get(c)!==l&&(e.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,n.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){let d=c.skeleton;s.get(d)!==l&&(d.update(),s.set(d,l))}return u}function o(){s=new WeakMap}function a(c){let l=c.target;l.removeEventListener("dispose",a),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:o}}var Eo=class extends $e{constructor(t,e,i,s,r,o,a,c,l,h){if(h=h!==void 0?h:Di,h!==Di&&h!==bs)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&h===Di&&(i=hi),i===void 0&&h===bs&&(i=Ii),super(null,s,r,o,a,c,h,i,l),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:Ie,this.minFilter=c!==void 0?c:Ie,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){let e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}},Ru=new $e,Cu=new Eo(1,1);Cu.compareFunction=bu;var Pu=new po,Lu=new nc,Iu=new vo,zh=[],kh=[],Gh=new Float32Array(16),Vh=new Float32Array(9),Wh=new Float32Array(4);function Cs(n,t,e){let i=n[0];if(i<=0||i>0)return n;let s=t*e,r=zh[s];if(r===void 0&&(r=new Float32Array(s),zh[s]=r),t!==0){i.toArray(r,0);for(let o=1,a=0;o!==t;++o)a+=e,n[o].toArray(r,a)}return r}function be(n,t){if(n.length!==t.length)return!1;for(let e=0,i=n.length;e<i;e++)if(n[e]!==t[e])return!1;return!0}function Se(n,t){for(let e=0,i=t.length;e<i;e++)n[e]=t[e]}function Go(n,t){let e=kh[t];e===void 0&&(e=new Int32Array(t),kh[t]=e);for(let i=0;i!==t;++i)e[i]=n.allocateTextureUnit();return e}function mx(n,t){let e=this.cache;e[0]!==t&&(n.uniform1f(this.addr,t),e[0]=t)}function gx(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(be(e,t))return;n.uniform2fv(this.addr,t),Se(e,t)}}function xx(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(n.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(be(e,t))return;n.uniform3fv(this.addr,t),Se(e,t)}}function _x(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(be(e,t))return;n.uniform4fv(this.addr,t),Se(e,t)}}function yx(n,t){let e=this.cache,i=t.elements;if(i===void 0){if(be(e,t))return;n.uniformMatrix2fv(this.addr,!1,t),Se(e,t)}else{if(be(e,i))return;Wh.set(i),n.uniformMatrix2fv(this.addr,!1,Wh),Se(e,i)}}function vx(n,t){let e=this.cache,i=t.elements;if(i===void 0){if(be(e,t))return;n.uniformMatrix3fv(this.addr,!1,t),Se(e,t)}else{if(be(e,i))return;Vh.set(i),n.uniformMatrix3fv(this.addr,!1,Vh),Se(e,i)}}function Mx(n,t){let e=this.cache,i=t.elements;if(i===void 0){if(be(e,t))return;n.uniformMatrix4fv(this.addr,!1,t),Se(e,t)}else{if(be(e,i))return;Gh.set(i),n.uniformMatrix4fv(this.addr,!1,Gh),Se(e,i)}}function Ex(n,t){let e=this.cache;e[0]!==t&&(n.uniform1i(this.addr,t),e[0]=t)}function bx(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(be(e,t))return;n.uniform2iv(this.addr,t),Se(e,t)}}function Sx(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(be(e,t))return;n.uniform3iv(this.addr,t),Se(e,t)}}function wx(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(be(e,t))return;n.uniform4iv(this.addr,t),Se(e,t)}}function Tx(n,t){let e=this.cache;e[0]!==t&&(n.uniform1ui(this.addr,t),e[0]=t)}function Ax(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(be(e,t))return;n.uniform2uiv(this.addr,t),Se(e,t)}}function Rx(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(be(e,t))return;n.uniform3uiv(this.addr,t),Se(e,t)}}function Cx(n,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(be(e,t))return;n.uniform4uiv(this.addr,t),Se(e,t)}}function Px(n,t,e){let i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r=this.type===n.SAMPLER_2D_SHADOW?Cu:Ru;e.setTexture2D(t||r,s)}function Lx(n,t,e){let i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTexture3D(t||Lu,s)}function Ix(n,t,e){let i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTextureCube(t||Iu,s)}function Dx(n,t,e){let i=this.cache,s=e.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),e.setTexture2DArray(t||Pu,s)}function Ux(n){switch(n){case 5126:return mx;case 35664:return gx;case 35665:return xx;case 35666:return _x;case 35674:return yx;case 35675:return vx;case 35676:return Mx;case 5124:case 35670:return Ex;case 35667:case 35671:return bx;case 35668:case 35672:return Sx;case 35669:case 35673:return wx;case 5125:return Tx;case 36294:return Ax;case 36295:return Rx;case 36296:return Cx;case 35678:case 36198:case 36298:case 36306:case 35682:return Px;case 35679:case 36299:case 36307:return Lx;case 35680:case 36300:case 36308:case 36293:return Ix;case 36289:case 36303:case 36311:case 36292:return Dx}}function Nx(n,t){n.uniform1fv(this.addr,t)}function Ox(n,t){let e=Cs(t,this.size,2);n.uniform2fv(this.addr,e)}function Fx(n,t){let e=Cs(t,this.size,3);n.uniform3fv(this.addr,e)}function Bx(n,t){let e=Cs(t,this.size,4);n.uniform4fv(this.addr,e)}function Hx(n,t){let e=Cs(t,this.size,4);n.uniformMatrix2fv(this.addr,!1,e)}function zx(n,t){let e=Cs(t,this.size,9);n.uniformMatrix3fv(this.addr,!1,e)}function kx(n,t){let e=Cs(t,this.size,16);n.uniformMatrix4fv(this.addr,!1,e)}function Gx(n,t){n.uniform1iv(this.addr,t)}function Vx(n,t){n.uniform2iv(this.addr,t)}function Wx(n,t){n.uniform3iv(this.addr,t)}function Xx(n,t){n.uniform4iv(this.addr,t)}function qx(n,t){n.uniform1uiv(this.addr,t)}function Yx(n,t){n.uniform2uiv(this.addr,t)}function Zx(n,t){n.uniform3uiv(this.addr,t)}function Kx(n,t){n.uniform4uiv(this.addr,t)}function $x(n,t,e){let i=this.cache,s=t.length,r=Go(e,s);be(i,r)||(n.uniform1iv(this.addr,r),Se(i,r));for(let o=0;o!==s;++o)e.setTexture2D(t[o]||Ru,r[o])}function Jx(n,t,e){let i=this.cache,s=t.length,r=Go(e,s);be(i,r)||(n.uniform1iv(this.addr,r),Se(i,r));for(let o=0;o!==s;++o)e.setTexture3D(t[o]||Lu,r[o])}function jx(n,t,e){let i=this.cache,s=t.length,r=Go(e,s);be(i,r)||(n.uniform1iv(this.addr,r),Se(i,r));for(let o=0;o!==s;++o)e.setTextureCube(t[o]||Iu,r[o])}function Qx(n,t,e){let i=this.cache,s=t.length,r=Go(e,s);be(i,r)||(n.uniform1iv(this.addr,r),Se(i,r));for(let o=0;o!==s;++o)e.setTexture2DArray(t[o]||Pu,r[o])}function t_(n){switch(n){case 5126:return Nx;case 35664:return Ox;case 35665:return Fx;case 35666:return Bx;case 35674:return Hx;case 35675:return zx;case 35676:return kx;case 5124:case 35670:return Gx;case 35667:case 35671:return Vx;case 35668:case 35672:return Wx;case 35669:case 35673:return Xx;case 5125:return qx;case 36294:return Yx;case 36295:return Zx;case 36296:return Kx;case 35678:case 36198:case 36298:case 36306:case 35682:return $x;case 35679:case 36299:case 36307:return Jx;case 35680:case 36300:case 36308:case 36293:return jx;case 36289:case 36303:case 36311:case 36292:return Qx}}var oc=class{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.setValue=Ux(e.type)}},ac=class{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=t_(e.type)}},cc=class{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,i){let s=this.seq;for(let r=0,o=s.length;r!==o;++r){let a=s[r];a.setValue(t,e[a.id],i)}}},za=/(\w+)(\])?(\[|\.)?/g;function Xh(n,t){n.seq.push(t),n.map[t.id]=t}function e_(n,t,e){let i=n.name,s=i.length;for(za.lastIndex=0;;){let r=za.exec(i),o=za.lastIndex,a=r[1],c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){Xh(e,l===void 0?new oc(a,n,t):new ac(a,n,t));break}else{let u=e.map[a];u===void 0&&(u=new cc(a),Xh(e,u)),e=u}}}var vs=class{constructor(t,e){this.seq=[],this.map={};let i=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<i;++s){let r=t.getActiveUniform(e,s),o=t.getUniformLocation(e,r.name);e_(r,o,this)}}setValue(t,e,i,s){let r=this.map[e];r!==void 0&&r.setValue(t,i,s)}setOptional(t,e,i){let s=e[i];s!==void 0&&this.setValue(t,i,s)}static upload(t,e,i,s){for(let r=0,o=e.length;r!==o;++r){let a=e[r],c=i[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,s)}}static seqWithValue(t,e){let i=[];for(let s=0,r=t.length;s!==r;++s){let o=t[s];o.id in e&&i.push(o)}return i}};function qh(n,t,e){let i=n.createShader(t);return n.shaderSource(i,e),n.compileShader(i),i}var n_=37297,i_=0;function s_(n,t){let e=n.split(`
`),i=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let o=s;o<r;o++){let a=o+1;i.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return i.join(`
`)}function r_(n){let t=ie.getPrimaries(ie.workingColorSpace),e=ie.getPrimaries(n),i;switch(t===e?i="":t===lo&&e===co?i="LinearDisplayP3ToLinearSRGB":t===co&&e===lo&&(i="LinearSRGBToLinearDisplayP3"),n){case ei:case ko:return[i,"LinearTransferOETF"];case te:case kc:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[i,"LinearTransferOETF"]}}function Yh(n,t,e){let i=n.getShaderParameter(t,n.COMPILE_STATUS),s=n.getShaderInfoLog(t).trim();if(i&&s==="")return"";let r=/ERROR: 0:(\d+)/.exec(s);if(r){let o=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+s_(n.getShaderSource(t),o)}else return s}function o_(n,t){let e=r_(t);return`vec4 ${n}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function a_(n,t){let e;switch(t){case Tp:e="Linear";break;case Ap:e="Reinhard";break;case Rp:e="OptimizedCineon";break;case Cp:e="ACESFilmic";break;case Lp:e="AgX";break;case Pp:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function c_(n){return[n.extensionDerivatives||n.envMapCubeUVHeight||n.bumpMap||n.normalMapTangentSpace||n.clearcoatNormalMap||n.flatShading||n.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(n.extensionFragDepth||n.logarithmicDepthBuffer)&&n.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",n.extensionDrawBuffers&&n.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(n.extensionShaderTextureLOD||n.envMap||n.transmission)&&n.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(xs).join(`
`)}function l_(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(xs).join(`
`)}function h_(n){let t=[];for(let e in n){let i=n[e];i!==!1&&t.push("#define "+e+" "+i)}return t.join(`
`)}function u_(n,t){let e={},i=n.getProgramParameter(t,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){let r=n.getActiveAttrib(t,s),o=r.name,a=1;r.type===n.FLOAT_MAT2&&(a=2),r.type===n.FLOAT_MAT3&&(a=3),r.type===n.FLOAT_MAT4&&(a=4),e[o]={type:r.type,location:n.getAttribLocation(t,o),locationSize:a}}return e}function xs(n){return n!==""}function Zh(n,t){let e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Kh(n,t){return n.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}var d_=/^[ \t]*#include +<([\w\d./]+)>/gm;function lc(n){return n.replace(d_,p_)}var f_=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function p_(n,t){let e=Yt[t];if(e===void 0){let i=f_.get(t);if(i!==void 0)e=Yt[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,i);else throw new Error("Can not resolve #include <"+t+">")}return lc(e)}var m_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function $h(n){return n.replace(m_,g_)}function g_(n,t,e,i){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Jh(n){let t="precision "+n.precision+` float;
precision `+n.precision+" int;";return n.precision==="highp"?t+=`
#define HIGH_PRECISION`:n.precision==="mediump"?t+=`
#define MEDIUM_PRECISION`:n.precision==="lowp"&&(t+=`
#define LOW_PRECISION`),t}function x_(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===uu?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===Bc?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===$n&&(t="SHADOWMAP_TYPE_VSM"),t}function __(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ms:case Es:t="ENVMAP_TYPE_CUBE";break;case zo:t="ENVMAP_TYPE_CUBE_UV";break}return t}function y_(n){let t="ENVMAP_MODE_REFLECTION";return n.envMap&&n.envMapMode===Es&&(t="ENVMAP_MODE_REFRACTION"),t}function v_(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case du:t="ENVMAP_BLENDING_MULTIPLY";break;case Sp:t="ENVMAP_BLENDING_MIX";break;case wp:t="ENVMAP_BLENDING_ADD";break}return t}function M_(n){let t=n.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:i,maxMip:e}}function E_(n,t,e,i){let s=n.getContext(),r=e.defines,o=e.vertexShader,a=e.fragmentShader,c=x_(e),l=__(e),h=y_(e),u=v_(e),d=M_(e),p=e.isWebGL2?"":c_(e),g=l_(e),x=h_(r),m=s.createProgram(),f,y,_=e.glslVersion?"#version "+e.glslVersion+`
...
`.trim(),document.head.appendChild(n)}function of(n,t,e){let i=document.createElement(n);return t&&(i.className=t),e&&e.appendChild(i),i}function cf(n={}){Yv();let t=of("div");t.id="aus101-reticule",t.setAttribute("aria-label","Reticule bay");let e=[],i=[],s=0,r=-1;for(let p=0;p<ef;p++){e.push({id:p,kind:null,mesh:null,coverage:0,dose:0,burn:!1,applying:!1,_seq:0,_prevCov:0});let g=of("div","aus101-ret-slot is-empty",t);g.dataset.slot=String(p),g.addEventListener("pointerdown",x=>{let m=e[p];m.mesh&&(x.preventDefault(),x.stopPropagation(),r=p,n.onSelect?.(m),t.dispatchEvent(new CustomEvent("aus101-reticule-select",{detail:m})),c())}),i.push(g)}function o(p){let g=qv(p.id+1);if(!p.mesh)return`SUBJECT ${g} // \u2014\u2014`;if(p.burn||p.dose>1)return`SUBJECT ${g} // BURN`;let x=Math.max(0,Math.round((1-p.dose)*100));return`SUBJECT ${g} // TELOMERE ${x}%`}function a(p){let g=e[p],x=i[p];x.textContent=o(g);let m=!!g.mesh;x.className="aus101-ret-slot",m?x.classList.add("is-live"):x.classList.add("is-empty"),m&&(g.burn||g.dose>1)?x.classList.add("is-burn"):m&&g.coverage>=nf&&x.classList.add("is-locked"),m&&g.applying&&x.classList.add("is-applying"),m&&r===p&&x.classList.add("is-sel")}function c(){for(let p=0;p<ef;p++)a(p)}function l(p,g){let x=_r(g),m=x.userData||(x.userData={});p.kind=af(g),p.mesh=x,p.coverage=rf(g),p.dose=Number.isFinite(m.dose)?m.dose:0,p.burn=p.dose>1||!!m.burn,p.applying=!1,p._seq=++s,p._prevCov=p.coverage,m.dose=p.dose,p.burn&&(m.burn=!0),a(p.id)}function h(p){p.kind=null,p.mesh=null,p.coverage=0,p.dose=0,p.burn=!1,p.applying=!1,p._seq=0,p._prevCov=0,r===p.id&&(r=-1),a(p.id)}function u(p){if(!Xv(p))return null;let g=_r(p),x=e.find(f=>f.mesh===g);if(x)return x;let m=e.find(f=>!f.mesh);return m||(m=e.reduce((f,y)=>f._seq<=y._seq?f:y),h(m)),l(m,p),m}function d(p,g){let x=_r(g),m=Number.isFinite(p)?Math.max(0,p):0;for(let f of e){if(!f.mesh)continue;let y=rf(f.mesh);f.coverage=y;let _=y>f._prevCov+1e-5,E=x===f.mesh||_;f.applying=E,f._prevCov=y,y<nf&&!E&&(f.dose+=(1-y)*m*Wv),f.dose>1&&(f.burn=!0);let R=f.mesh.userData||(f.mesh.userData={});R.coverage=y,R.dose=f.dose,f.burn&&(R.burn=!0),a(f.id)}}return c(),{track:u,tick:d,html:t,slots:e}}var yr=["boardwalk","apply","menu"],Zv=["dj_song_01","dj_song_02","dj_song_03"];function Kv(n){return n<10?`0${n}`:String(n)}function $v(){let n=t=>typeof matchMedia=="function"?matchMedia(t).matches:!1;return typeof matchMedia!="function"?"ontouchstart"in window:!!(n("(pointer: coarse)")||n("(any-pointer: coarse)")||"ontouchstart"in window&&n("(hover: none)"))}function Jv(){return typeof matchMedia=="function"&&matchMedia("(orientation: landscape)").matches?!0:window.innerWidth>window.innerHeight}function fn(n,t,e){let i=document.createElement(n);return t&&Object.assign(i.style,t),e&&e.appendChild(i),i}function jv(n,t){let e=t>>>0||1,i=n.slice();for(let s=i.length-1;s>0;s--){e=Math.imul(e,1664525)+1013904223>>>0;let r=e%(s+1),o=i[s];i[s]=i[r],i[r]=o}return i}function Qv(n){if(!n||n===document.body||n===document.documentElement)return!1;let t=(n.tagName||"").toLowerCase();return t==="input"||t==="textarea"||t==="select"?!0:!!n.isContentEditable}function tM(){let n=fn("span",{display:"flex",alignItems:"center",gap:"1px"});return fn("span",{width:"2px",height:"10px",background:"currentColor",borderRadius:"1px"},n),fn("span",{width:"0",height:"0",borderStyle:"solid",borderWidth:"5px 8px 5px 0",borderColor:"transparent currentColor transparent transparent"},n),n}function eM(){let n=fn("span",{display:"flex",alignItems:"center",gap:"1px"});return fn("span",{width:"0",height:"0",borderStyle:"solid",borderWidth:"5px 0 5px 8px",borderColor:"transparent transparent transparent currentColor"},n),fn("span",{width:"2px",height:"10px",background:"currentColor",borderRadius:"1px"},n),n}function lf(){let n=fn("span",{display:"flex",alignItems:"center",gap:"3px"}),t=()=>fn("span",{width:"3px",height:"10px",background:"currentColor",borderRadius:"1px"},n);return t(),t(),n}function nM(){return fn("span",{width:"0",height:"0",marginLeft:"2px",borderStyle:"solid",borderWidth:"6px 0 6px 9px",borderColor:"transparent transparent transparent currentColor"})}function ul(n,t){let e=fn("button",{width:"26px",height:"26px",borderRadius:"50%",padding:"0",margin:"0",border:"1px solid rgba(251,246,234,0.28)",background:"rgba(12,18,16,0.42)",color:"rgba(251,246,234,0.92)",boxShadow:"inset 0 0 0 1px rgba(0,0,0,0.18), 0 3px 12px rgba(0,0,0,0.28)",display:"flex",alignItems:"center",justifyContent:"center",pointerEvents:"auto",touchAction:"none",cursor:"pointer",appearance:"none",webkitAppearance:"none",outline:"none",backdropFilter:"blur(8px)",webkitBackdropFilter:"blur(8px)",userSelect:"none",webkitUserSelect:"none"});return e.type="button",e.tabIndex=-1,e.setAttribute("aria-label",t),e.appendChild(n),e}function iM(){let n=[];for(let t=1;t<=49;t++)n.push(`dj_quip_${Kv(t)}`);return jv(n,performance.now()*997|0)}function hf({carpenter:n,voice:t,isTalking:e}={}){let i=yr.indexOf(n?.state);i<0&&(i=0);let s=n?n.running===!1:!1,r=1,o=!1,a=[],c=!1,l=null;if(!document.getElementById("aus101-radio-css")){let O=document.createElement("style");O.id="aus101-radio-css",O.textContent="#aus101-radio,#aus101-radio *{box-sizing:border-box;-webkit-tap-highlight-color:transparent;}#aus101-radio button:active{background:rgba(255,215,106,0.28)!important;}#aus101-radio .radio-vol{-webkit-appearance:none;appearance:none;width:56px;height:18px;background:transparent;padding:0;margin:0 2px 0 0;cursor:pointer;}#aus101-radio .radio-vol::-webkit-slider-runnable-track{height:3px;border-radius:2px;background:rgba(251,246,234,0.28);}#aus101-radio .radio-vol::-webkit-slider-thumb{-webkit-appearance:none;width:10px;height:10px;border-radius:50%;background:#ffd76a;margin-top:-3.5px;border:0;}#aus101-radio .radio-vol::-moz-range-track{height:3px;border-radius:2px;background:rgba(251,246,234,0.28);}#aus101-radio .radio-vol::-moz-range-thumb{width:10px;height:10px;border-radius:50%;background:#ffd76a;border:0;}#aus101-radio[data-touch='1'] .radio-vol{display:none;}",document.head.appendChild(O)}let h=fn("div",{position:"fixed",zIndex:"12",pointerEvents:"none",userSelect:"none",webkitUserSelect:"none",touchAction:"none"});h.id="aus101-radio",h.setAttribute("role","group"),h.setAttribute("aria-label","Reticule FM 101.7");let u=fn("div",{display:"flex",alignItems:"center",gap:"8px",pointerEvents:"auto",touchAction:"none"},h),d=document.createElement("input");d.type="range",d.className="radio-vol",d.min="0",d.max="1",d.step="0.01",d.value="1",d.tabIndex=-1,d.setAttribute("aria-label","Volume"),u.appendChild(d);let p=ul(tM(),"Previous"),g=ul(lf(),"Pause"),x=ul(eM(),"Next"),m=fn("span",{position:"absolute",width:"5px",height:"5px",borderRadius:"50%",right:"3px",top:"3px",background:"#ffd76a",boxShadow:"0 0 6px rgba(255,215,106,0.7)",pointerEvents:"none"});g.style.position="relative",g.appendChild(m),u.append(p,g,x);function f(){if(t?.busy)return!0;if(typeof e=="function")try{if(e(performance.now()))return!0}catch{}return!1}function y(){return a.length||(a=iM()),a.pop()}function _(){if(typeof t?.play!="function"){o=!1;return}if(f()){o=!0;return}o=!1;let O=Zv[i]||"dj_song_01",X=t.play(O);X.ready?.then(z=>{if(!z){o=!0;return}let k=X.onended;X.onended=()=>{if(typeof k=="function"&&k(),f())return;let F=y();F&&t.play(F)}})}function E(O){r=Math.max(0,Math.min(1,O)),d.value!==String(r)&&(d.value=String(r)),n?.setMix?.(r)}function R(){g.replaceChildren(s?nM():lf(),m),g.setAttribute("aria-label",s?"Play":"Pause"),g.setAttribute("aria-pressed",s?"true":"false")}function T(){let O=["#ffd76a","#fbf6ea","#ff6a4a"];m.style.background=O[i]||O[0],m.style.boxShadow=`0 0 6px ${O[i]||O[0]}`}function A(O){n?.setState?.(yr[i]),s||(n?.start?.(),n?.setMix?.(r)),T(),O&&_()}function D(O){i=(i+O+yr.length)%yr.length,A(!0)}function v(){s=!s,s?n?.stop?.():(n?.setState?.(yr[i]),n?.start?.(),n?.setMix?.(r)),R()}function b(){let X=Jv()?"max(20px, calc(env(safe-area-inset-top, 0px) + 4px))":"max(12px, calc(env(safe-area-inset-top, 0px) + 6px))";h.style.top=X,h.style.right="max(10px, env(safe-area-inset-right, 0px))",h.dataset.touch=$v()?"1":"0"}let U=O=>{if(c||O.metaKey||O.ctrlKey||O.altKey||Qv(O.target))return;let X=O.code,z=O.key;if(X==="Minus"||X==="NumpadSubtract"||z==="-"||z==="_"){E(r-.06),O.preventDefault();return}if(X==="Equal"||X==="NumpadAdd"||z==="="||z==="+"){E(r+.06),O.preventDefault();return}if(!O.repeat){if(X==="BracketLeft"||z==="["||X==="Comma"||z===","){D(-1),O.preventDefault();return}if(X==="BracketRight"||z==="]"||X==="Period"||z==="."){D(1),O.preventDefault();return}(X==="KeyP"||z==="p"||z==="P")&&(v(),O.preventDefault())}},q=()=>E(parseFloat(d.value)),Q=O=>{if(!(O.pointerType==="mouse"&&O.button!==0)&&O.target!==d){l={id:O.pointerId,y:O.clientY,vol:r,moved:!1};try{u.setPointerCapture(O.pointerId)}catch{}}},L=O=>{if(!l||O.pointerId!==l.id)return;let X=l.y-O.clientY;Math.abs(X)>7&&(l.moved=!0),l.moved&&E(l.vol+X/140)},N=O=>{if(!l||O.pointerId!=null&&O.pointerId!==l.id)return;let X=l.moved;l=null,X&&(O.preventDefault(),O.stopPropagation())};function G(O,X){O.addEventListener("pointerup",z=>{l?.moved||(z.preventDefault(),z.stopPropagation(),X())}),O.addEventListener("click",z=>{z.preventDefault(),z.stopPropagation()})}return G(p,()=>D(-1)),G(g,()=>v()),G(x,()=>D(1)),d.addEventListener("input",q),d.addEventListener("change",q),u.addEventListener("pointerdown",Q),u.addEventListener("pointermove",L),u.addEventListener("pointerup",N),u.addEventListener("pointercancel",N),window.addEventListener("keydown",U),window.addEventListener("resize",b),window.addEventListener("orientationchange",b),b(),R(),T(),document.body.appendChild(h),{el:h,tick(){c||(b(),o&&!f()&&_())},dispose(){c||(c=!0,o=!1,window.removeEventListener("keydown",U),window.removeEventListener("resize",b),window.removeEventListener("orientationchange",b),d.removeEventListener("input",q),d.removeEventListener("change",q),u.removeEventListener("pointerdown",Q),u.removeEventListener("pointermove",L),u.removeEventListener("pointerup",N),u.removeEventListener("pointercancel",N),h.remove())}}}var Xe=64,uf=256,sM=170,df=.08,ff=1,ta=.82,ea=.6,mf=16052196,rM=8898799,pf=`
varying vec2 vUv;
void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`;function nn(n,t={}){return new Qt({color:n,roughness:.72,metalness:.04,...t})}function Mr(n){return n.castShadow=!0,n.receiveShadow=!0,n}function ii(n,t,e,i){return Mr(new W(new Gt(n,t,e),i))}function vr(n,t,e=10,i=8){return Mr(new W(new jt(n,e,i),t))}function zn(n,t,e,i,s=8){return Mr(new W(new Ot(n,t,e,s),i))}function dl(n,t,{depth:e=!1,colorSpace:i=Ne}={}){let s=new An(n,t,{minFilter:Me,magFilter:Me,format:cn,type:xn,depthBuffer:e,stencilBuffer:!1,generateMipmaps:!1});return s.texture.colorSpace=i,s.texture.flipY=!1,s}function cM(){let n=new St,t=nn(8015402,{roughness:.9}),e=nn(4861462,{roughness:.88}),i=nn(mf,{roughness:.96});for(let[l,h,u]of[[-.3,.14,.08],[.3,.14,-.08],[0,-.2,0]]){let d=ii(.048,1.52,.048,t);d.position.set(l,.76,h),d.rotation.z=u,n.add(d)}let s=ii(.72,.04,.16,e);s.position.set(0,.52,.1),n.add(s);let r=ii(.7,.04,.04,t);r.position.set(0,1.46,.08),n.add(r);let o=ii(ta+.04,ea+.04,.028,i);o.position.set(0,1.16,.11),o.rotation.x=-.1,n.add(o);let a=ii(.03,.08,.03,e);a.position.set(-.34,.84,.12);let c=ii(.03,.08,.03,e);return c.position.set(.34,.84,.12),n.add(a,c),{group:n,board:o}}function lM(){let n=new St,t=nn(13213818,{roughness:.62}),e=nn(14207920,{roughness:.86}),i=nn(7035450,{roughness:.82}),s=nn(15260064,{roughness:.92}),r=nn(6967360,{roughness:.88}),o=ii(.3,.48,.17,e);o.position.y=1.12,n.add(o);let a=ii(.26,.14,.16,i);a.position.y=.84,n.add(a);let c=vr(.115,t,12,10);c.position.y=1.5,n.add(c);let l=vr(.12,r,10,8);l.position.set(0,1.53,-.01),l.scale.set(1.02,.72,1.04),n.add(l);let h=zn(.18,.18,.02,s,14);h.position.y=1.6;let u=zn(.11,.12,.08,s,12);u.position.y=1.65,n.add(h,u);let d=zn(.036,.04,.26,e);d.position.set(-.2,1.2,.02),d.rotation.z=.35;let p=zn(.03,.034,.22,t);p.position.set(-.28,1,.08),p.rotation.z=.55,p.rotation.x=-.4;let g=vr(.03,t,8,6);g.position.set(-.32,.9,.16),n.add(d,p,g);let x=Mr(new W(new or(.08,10),nn(13351062,{roughness:.7})));x.position.set(-.3,.88,.2),x.rotation.x=-1.15,x.rotation.z=.4,n.add(x);for(let[v,b,U]of[[-.025,.02,13123630],[.02,.025,3108762],[.015,-.02,13934615],[-.02,-.018,3832378]]){let q=new W(new or(.016,6),nn(U,{roughness:.55}));q.position.set(-.3+v,.882,.2+b),q.rotation.copy(x.rotation),n.add(q)}let m=new St;m.position.set(.18,1.34,.04);let f=vr(.042,e,8,6);m.add(f);let y=zn(.034,.038,.28,e);y.rotation.x=Math.PI/2,y.position.z=.14,m.add(y);let _=zn(.028,.032,.24,t);_.rotation.x=Math.PI/2,_.position.z=.38,m.add(_);let E=vr(.03,t,8,6);E.position.z=.52,m.add(E);let R=new St,T=zn(.009,.011,.26,nn(5913114,{roughness:.7}),6);T.rotation.x=Math.PI/2,T.position.z=.13;let A=zn(.012,.012,.03,nn(11575408,{metalness:.45,roughness:.4}),6);A.rotation.x=Math.PI/2,A.position.z=.26;let D=Mr(new W(new we(.016,.055,6),nn(3811864,{roughness:.9})));D.rotation.x=Math.PI/2,D.position.z=.3,R.add(T,A,D),R.position.z=.5,m.add(R),n.add(m);for(let v of[-1,1]){let b=zn(.048,.052,.28,i);b.position.set(v*.08,.64,0);let U=zn(.038,.046,.3,i);U.position.set(v*.08,.36,0);let q=ii(.07,.04,.13,nn(3813416));q.position.set(v*.08,.02,.03),n.add(b,U,q)}return n.userData.arm=m,n.userData.brush=R,n.userData.paintTarget=!1,n.userData.kind="artist",n.userData.ageBand="adult",n}function hM(n){let t=-1,e=Xe>>1,i=Xe>>1,s=Xe*Xe;for(let r=0;r<s;r++){let o=r*4,a=n[o]*n[o]+n[o+1]*n[o+1]+n[o+2]*n[o+2];a>t&&(t=a,e=r%Xe,i=r/Xe|0)}return{u:(e+.5)/Xe,v:(i+.5)/Xe,err:t}}function gf(n,t={x:4.5,z:-6.2,yaw:-2.6}){let e=new St;e.name="artist",e.position.set(t.x,0,t.z),e.rotation.y=t.yaw+Math.PI,e.userData.kind="artist",e.userData.ageBand="adult",e.userData.paintTarget=!1;let{group:i,board:s}=cM(),r=lM();r.position.set(-.4,0,.34),r.rotation.y=Math.PI+.32,e.add(i,r),n.add(e),e.updateMatrixWorld(!0);let o=dl(Xe,Xe,{depth:!0,colorSpace:te}),a=dl(uf,uf,{depth:!1,colorSpace:te}),c=dl(Xe,Xe,{depth:!1,colorSpace:Ne}),l=new le({map:a.texture,toneMapped:!1}),h=new W(new me(ta,ea),l);h.position.copy(s.position),h.position.z+=.018,h.rotation.copy(s.rotation),h.layers.set(ff),h.layers.enable(0),s.layers.set(ff),s.layers.enable(0),i.add(h);let u=t.x+Math.sin(t.yaw)*14,d=t.z+Math.cos(t.yaw)*14,p=new Ue(42,ta/ea,.28,90),g=new C(0,1.54,.08);r.localToWorld(g),p.position.set(g.x+Math.sin(t.yaw)*.14,g.y,g.z+Math.cos(t.yaw)*.14),p.lookAt(u,1.15,d),p.layers.set(0),p.updateProjectionMatrix();let x=new ws(-1,1,1,-1,0,1),m=new _n({uniforms:{viewMap:{value:o.texture},paintMap:{value:a.texture}},vertexShader:pf,fragmentShader:oM,depthTest:!1,depthWrite:!1,toneMapped:!1}),f=new Oi;f.add(new W(new me(2,2),m));let y=new _n({uniforms:{viewMap:{value:o.texture},center:{value:new ct(.5,.5)},radius:{value:df},amount:{value:.7}},vertexShader:pf,fragmentShader:aM,transparent:!0,blending:fi,depthTest:!1,depthWrite:!1,toneMapped:!1}),_=new Oi;_.add(new W(new me(2,2),y));let E=new Uint8Array(Xe*Xe*4),R=new It(mf),T=new It(rM),A=new It,D=new ct(.5,.5),v=new C,b=new C,U=new Rn,q=new Rn,Q=r.userData.arm,L=r.userData.brush,N=!1,G=0,O=.5;function X(F,tt,V,J,lt){F.shadowMap.enabled=lt,F.autoClear=V,F.setClearColor(A,J),F.setRenderTarget(tt)}function z(F,tt){let V=F.getRenderTarget(),J=F.autoClear,lt=F.getClearAlpha(),bt=F.shadowMap.enabled;F.getClearColor(A),F.autoClear=!0,F.shadowMap.enabled=!1,N||(F.setRenderTarget(a),F.setClearColor(R,1),F.clear(),N=!0),h.visible=!1,s.visible=!1,F.setRenderTarget(o),F.setClearColor(T,1),F.render(tt,p),h.visible=!0,s.visible=!0,F.setRenderTarget(c),F.setClearColor(0,1),F.render(f,x),F.readRenderTargetPixels(c,0,0,Xe,Xe,E);let gt=hM(E);D.set(gt.u,gt.v),O=.62,y.uniforms.center.value.set(gt.u,gt.v),y.uniforms.radius.value=df*(.72+Math.random()*.5),y.uniforms.amount.value=.58+Math.min(.36,gt.err/9e4),F.autoClear=!1,F.setRenderTarget(a),F.render(_,x),X(F,V,J,lt,bt)}function k(){v.set((D.x-.5)*ta,(D.y-.5)*ea,.02),h.localToWorld(b.copy(v)),U.copy(Q.quaternion),Q.lookAt(b),q.copy(Q.quaternion),Q.quaternion.copy(U).slerp(q,.2),O+=(.5-O)*.16,L.position.z=O}return{root:e,pose:t,tick(F,tt,V){V-G>=sM&&(z(F,tt),G=V),k()}}}var uM=9131048,dM=12886122,fM=2889744;function Yi(n,t={}){return new Qt({color:n,roughness:.72,metalness:.04,...t})}function In(n){return n.castShadow=!0,n.receiveShadow=!0,n}function pM(){let n=new St,t=Yi(uM,{roughness:.62,metalness:.08}),e=Yi(dM,{roughness:.5}),i=Yi(fM,{roughness:.48}),s=In(new W(new jt(.15,10,8),t));s.scale.set(1.05,1.22,.28),n.add(s);let r=In(new W(new jt(.12,10,8),t));r.scale.set(.95,1.05,.28),r.position.set(0,-.12,0),n.add(r);let o=In(new W(new Gt(.042,.48,.032),e));o.position.set(0,.4,0),n.add(o);let a=In(new W(new Gt(.068,.1,.028),t));a.position.set(0,.68,0),n.add(a);let c=In(new W(new Ot(.042,.042,.02,12),i));c.rotation.x=Math.PI/2,c.position.set(0,.02,.04),n.add(c);let l=In(new W(new Gt(.08,.018,.016),i));return l.position.set(0,-.1,.038),n.add(l),n}function xf(n,t){let e=[];for(let r of[...n.children])t*r.position.x>.15&&r.position.y>.85&&e.push(r);let i=new St;if(!e.length)return i;let s=e.reduce((r,o)=>r.position.y>=o.position.y?r:o);i.position.copy(s.position),n.add(i);for(let r of e)r.position.sub(i.position),i.add(r);return i}function _f(n,t,e,i,s){let r=Mi(n);r.position.set(t,e,i),r.rotation.y=s;let o=pM();o.position.set(.08,.9,.2),o.rotation.set(.22,.12,1.05),r.add(o);let a=xf(r,1);a.rotation.set(-1.12,.08,-.52);let c=xf(r,-1);return c.rotation.set(-.98,-.06,.72),{mesh:r,guitar:o,strum:a,fret:c,yaw:s}}function mM(){let n=new St,t=Yi(1710622,{roughness:.42,metalness:.35}),e=Yi(10133672,{roughness:.28,metalness:.65}),i=Yi(1118481,{roughness:.55,metalness:.4}),s=In(new W(new Gt(.92,.42,.32),t));s.position.y=.22,n.add(s);for(let a of[-.26,.26]){let c=In(new W(new Ot(.155,.155,.04,16),e));c.rotation.x=Math.PI/2,c.position.set(a,.22,.155),n.add(c);let l=In(new W(new Ot(.08,.13,.03,14),i));l.rotation.x=Math.PI/2,l.position.set(a,.22,.175),n.add(l)}let r=In(new W(new yi(.16,.016,6,12,Math.PI),e));r.rotation.set(0,0,Math.PI),r.position.set(0,.44,0),n.add(r);let o=In(new W(new Gt(.22,.1,.02),Yi(2763312,{metalness:.25})));return o.position.set(0,.22,.165),n.add(o),n}function yf(n,t,e,i){let s=Ls(n);return s.position.set(t,0,e),s.rotation.y=i,{mesh:s,yaw:i,phase:t*.7+e*.4}}function vf(n){let t=new C(-6,0,5),e=new C(5,0,3),i=new C(12,0,8),s=_f({hair:16769162,shorts:936530,skin:14198126},t.x,0,t.z,.35),r=_f({hair:15783050,shorts:13123630,skin:13537112},e.x,0,e.z,-.4);s.mesh.name="ken-guitar-a",r.mesh.name="ken-guitar-b",n.add(s.mesh,r.mesh);let o=mM();o.position.copy(i),o.name="boombox",n.add(o);let a=yf({hair:1708560,bikini:16739226,skin:15251608},10.85,7.15,.55),c=yf({hair:15909166,bikini:3112912,skin:14262392},13.2,8.7,-.7);a.mesh.name="babe-boom-a",c.mesh.name="babe-boom-b",n.add(a.mesh,c.mesh);let l=[s,r],h=[a,c];return{tick(u){for(let d=0;d<l.length;d++){let p=l[d],g=Math.sin(u*8.2+d*1.7);p.strum.rotation.x=-1.12+g*.14,p.strum.rotation.z=-.52+g*.08,p.guitar.rotation.z=1.05+g*.035,p.guitar.rotation.x=.22+Math.abs(g)*.02,p.fret.rotation.z=.72+Math.sin(u*3.4+d)*.04,p.mesh.rotation.y=p.yaw+Math.sin(u*1.1+d)*.04}for(let d of h){let p=Math.sin(u*4.6+d.phase);d.mesh.position.y=Math.abs(p)*.14,d.mesh.rotation.z=Math.sin(u*2.3+d.phase)*.16,d.mesh.rotation.y=d.yaw+Math.sin(u*1.7+d.phase)*.28}},musicSpots:[{id:"guitar-a",position:s.mesh.position,radius:7},{id:"guitar-b",position:r.mesh.position,radius:7},{id:"boombox",position:o.position,radius:8},{id:"dj",position:new C(-24,0,7),radius:10}]}}var gM=16,xM=.15,_M=0,yM=4,pl=.4,ml=.8,vM=2.2,Us=1/60,fl=.984,Mf=1,Rf=5,MM=4,EM={torso:new Gt(.34,.5,.18),head:new Gt(.22,.22,.22),arm:new Gt(.09,.5,.09),leg:new Gt(.11,.7,.11)},Ds=[{id:"torso",geo:"torso",ox:0,oy:1.16,oz:0,half:.25,inv:.35,mat:"skin"},{id:"head",geo:"head",ox:0,oy:1.62,oz:0,half:.11,inv:.85,mat:"skin"},{id:"armL",geo:"arm",ox:-.28,oy:1.2,oz:0,half:.25,inv:1,mat:"skin"},{id:"armR",geo:"arm",ox:.28,oy:1.2,oz:0,half:.25,inv:1,mat:"skin"},{id:"legL",geo:"leg",ox:-.09,oy:.36,oz:0,half:.35,inv:1,mat:"shorts"},{id:"legR",geo:"leg",ox:.09,oy:.36,oz:0,half:.35,inv:1,mat:"shorts"}],bM=Ds.slice(1).map(n=>({a:0,b:Ds.indexOf(n),rest:Math.hypot(n.ox-Ds[0].ox,n.oy-Ds[0].oy,n.oz-Ds[0].oz)})),Ef=[{hair:16041009,shorts:2060152,skin:13934698},{hair:16739226,shorts:1723788,skin:13406042},{hair:16048762,shorts:14826299,skin:14721120},{hair:6211839,shorts:15909166,skin:13931082}],SM=[{x:16,z:2,axis:"x"},{x:-10,z:-3,axis:"z"}];function Zi(n,t){return n+Math.random()*(t-n)}function bf(n){return new Qt({color:n,roughness:.72,metalness:.04})}function wM(n,t,e){let i=Math.cos(e),s=Math.sin(e);return{x:n*i-t*s,z:n*s+t*i}}function TM(n,t){return Math.atan2(t.x-n.x,t.z-n.z)}function AM(n,t){let e=bf(t.skin),i=bf(t.shorts),s=new St;s.name="ken-ragdoll",s.visible=!1;let r=Ds.map(o=>{let a=o.mat==="shorts"?i:e,c=new W(EM[o.geo],a);return c.castShadow=!0,c.receiveShadow=!0,s.add(c),{mesh:c,x:0,y:o.oy,z:0,px:0,py:o.oy,pz:0,half:o.half,inv:o.inv,rx:0,rz:0,ox:o.ox,oy:o.oy,oz:o.oz}});return n.add(s),{root:s,parts:r}}function RM(n,t,e,i){let s=n.mesh.rotation.y,r=n.x,o=n.z;for(let a of n.doll.parts){let c=wM(a.ox,a.oz,s);a.x=r+c.x,a.y=a.oy,a.z=o+c.z;let l=t+Zi(-1.4,1.4),h=e+Zi(.4,2.2),u=i+Zi(-1.4,1.4);a.px=a.x-l*Us,a.py=a.y-h*Us,a.pz=a.z-u*Us,a.rx=0,a.rz=0,a.mesh.position.set(a.x,a.y,a.z),a.mesh.rotation.set(0,s,0)}}function CM(n,t){let e=-gM*t*t;for(let i of n){let s=(i.x-i.px)*fl,r=(i.y-i.py)*fl,o=(i.z-i.pz)*fl;i.px=i.x,i.py=i.y,i.pz=i.z,i.x+=s,i.y+=r+e,i.z+=o,i.rx+=o*10,i.rz-=s*10}}function PM(n){for(let t of bM){let e=n[t.a],i=n[t.b],s=i.x-e.x,r=i.y-e.y,o=i.z-e.z,a=Math.hypot(s,r,o)||1e-6,c=e.inv+i.inv,l=(a-t.rest)/a*(1/c);e.x+=s*l*e.inv,e.y+=r*l*e.inv,e.z+=o*l*e.inv,i.x-=s*l*i.inv,i.y-=r*l*i.inv,i.z-=o*l*i.inv}}function LM(n){for(let t of n){let e=_M+t.half;if(t.y>=e)continue;let i=t.x-t.px,s=t.y-t.py,r=t.z-t.pz;t.y=e,t.py=s<0?t.y+s*xM:t.y,t.px=t.x-i*.7,t.pz=t.z-r*.7}}function IM(n){for(let t of n.doll.parts)t.mesh.position.set(t.x,t.y,t.z),t.mesh.rotation.set(t.rx,n.mesh.rotation.y,t.rz)}function Cf(n,t){n.state=t;let e=t==="ragdoll";n.mesh.visible=!e,n.doll.root.visible=e}function Sf(n){n.x=n.home.x,n.z=n.home.z,n.vx=0,n.vz=0,n.hp=Rf+(Math.random()*3|0),n.cool=Zi(pl,ml),n.punch=0,n.acc=0,n.mesh.position.set(n.home.x,0,n.home.z),n.mesh.rotation.set(0,n.home.yaw,0),Cf(n,"stand")}function DM(n,t,e,i){let s=3.2+i*2.4;RM(n,t*s,3.4+i*2,e*s),Cf(n,"ragdoll")}function UM(n,t){let e=t.x-n.x,i=t.z-n.z,s=Math.hypot(e,i)||1,r=e/s,o=i/s,a=Math.random()<.14,c=a?1.35:Zi(.7,1.05);if(n.vx+=r*1.6*c,n.vz+=o*1.6*c,n.punch=.16,t.state==="stand")t.vx+=r*2.8*c,t.vz+=o*2.8*c,t.hp-=a?Mf*2:Mf,t.hp<=0&&DM(t,r,o,c);else{let l=t.doll.parts[0];l.px-=r*.1*c,l.pz-=o*.1*c,l.py-=.03*c}}function wf(n,t,e){n.cool-=e,n.cool<=0&&(n.cool=Zi(pl,ml),UM(n,t)),n.vx+=(n.home.x-n.x)*6*e,n.vz+=(n.home.z-n.z)*6*e,n.vx*=Math.max(0,1-5.5*e),n.vz*=Math.max(0,1-5.5*e),n.x+=n.vx*e,n.z+=n.vz*e,n.mesh.rotation.y=TM(n,t);let i=n.x,s=n.z,r=0;if(n.punch>0){n.punch=Math.max(0,n.punch-e);let o=Math.sin((1-n.punch/.16)*Math.PI),a=Math.sin(n.mesh.rotation.y),c=Math.cos(n.mesh.rotation.y);i+=a*o*.38,s+=c*o*.38,r=o*.14}n.mesh.position.set(i,0,s),n.mesh.rotation.x=r}function Tf(n,t){for(n.acc+=Math.min(t,.05);n.acc>=Us;){n.acc-=Us,CM(n.doll.parts,Us);for(let i=0;i<MM;i++)PM(n.doll.parts);LM(n.doll.parts)}IM(n);let e=n.doll.parts[0];n.x=e.x,n.z=e.z}function Af(n,t,e,i,s){let r=Mi(s);return r.position.set(t,0,e),r.rotation.y=i,r.userData.fight=!0,r.userData.paintTarget=!1,n.add(r),{mesh:r,doll:AM(n,s),home:{x:t,z:e,yaw:i},x:t,z:e,vx:0,vz:0,hp:Rf,cool:Zi(pl,ml),punch:0,acc:0,state:"stand"}}function NM(n,t,e,i){let s=vM*.5,r=t.x,o=t.z,a=t.x,c=t.z,l=0,h=Math.PI;return t.axis==="x"?(r-=s,a+=s,l=Math.PI*.5,h=-Math.PI*.5):(o-=s,c+=s,l=0,h=Math.PI),{a:Af(n,r,o,l,e),b:Af(n,a,c,h,i),down:0}}function Pf(n){let t=SM.map((i,s)=>NM(n,i,Ef[s*2],Ef[s*2+1]));function e(i){if(!(i>0))return;let s=Math.min(i,.05);for(let r of t)r.a.state==="stand"&&wf(r.a,r.b,s),r.b.state==="stand"&&wf(r.b,r.a,s),r.a.state==="ragdoll"&&Tf(r.a,s),r.b.state==="ragdoll"&&Tf(r.b,s),(r.a.state==="ragdoll"||r.b.state==="ragdoll")&&(r.down+=s,r.down>=yM&&(Sf(r.a),Sf(r.b),r.down=0))}return{tick:e}}var Er=5.5;var Lf={x:0,z:10},OM=[[-20,16],[0,12],[18,8],[8,-2],[-12,8]],If=["assets/media/psa/psa1.mp4","assets/media/psa/psa2.mp4","assets/media/psa/psa3.mp4","assets/media/psa/psa4.mp4","assets/media/psa/psa5.mp4"],Df=["assets/media/cutscene/s4_i_can_use_them.jpg","assets/media/ads/billboard_terminate_uv.png","assets/media/ads/tv_surfclub.jpg","assets/media/ads/dj_slide_apply.jpg","assets/media/cutscene/aus101_ref.jpg"],FM=[["I CAN USE THEM","PUBLIC HEALTH REASSIGNMENT"],["TERMINATE UV","THE SUN IS A HOSTILE ACTOR"],["SURF CLUB NOTICE","ZINC ON \xB7 SHIRT OPTIONAL"],["APPLY","OR BE RECALLED"],["AUS101","DOES NOT TAKE REQUESTS"]];function BM(n,t){let e=document.createElement("canvas");e.width=512,e.height=384;let i=e.getContext("2d");i.fillStyle="#0b1210",i.fillRect(0,0,512,384),i.fillStyle="#1a3a28",i.fillRect(0,0,512,58),i.fillStyle="#c8a44a",i.fillRect(0,58,512,4),i.fillRect(0,380,512,4),i.fillStyle="#e8d48a",i.font="bold 18px Arial, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillText("DEPARTMENT OF WELLNESS",256,28),i.font="12px Arial, sans-serif",i.fillStyle="#9aaa88",i.fillText("GOLD COAST UNIT  \xB7  PSA",256,46),i.fillStyle="#f4f7fb",i.font="bold 42px Impact, Arial Black, sans-serif",i.fillText(n,256,188),i.fillStyle="#ffb040",i.font="bold 22px Arial, sans-serif",i.fillText(t,256,248),i.globalAlpha=.12,i.fillStyle="#000";for(let r=0;r<384;r+=3)i.fillRect(0,r,512,1);i.globalAlpha=1;let s=new ni(e);return s.colorSpace=te,s.needsUpdate=!0,s}function HM(n){let t=FM.map(([r,o])=>BM(r,o)),e=new Rs,i=Df.length,s=()=>{i-=1,i<=0&&n()};return Df.forEach((r,o)=>{e.load(r,a=>{a.colorSpace=te,a.needsUpdate=!0,t[o]=a,s()},void 0,s)}),t}function zM(n,t,e,i){let s=new St,r=ht(3817026,{metalness:.55,roughness:.42}),o=ht(1447962,{roughness:.62,metalness:.18}),a=ht(789518,{roughness:.5,metalness:.12}),c=new W(new Ot(.18,.22,.1,10),r);c.position.y=.05,c.castShadow=!0,s.add(c);let l=new W(new Ot(.05,.062,1.52,8),r);l.position.y=.86,l.castShadow=!0,s.add(l);let h=Ht(.16,.08,.16,r);h.position.y=1.58,s.add(h);let u=Ht(.78,.6,.26,o);u.position.y=1.78,s.add(u);let d=Ht(.74,.52,.04,a);d.position.set(0,1.78,.14),s.add(d);let p=Ht(.82,.07,.22,o);p.position.set(0,2.12,.06),s.add(p);let g=Ht(.5,.08,.02,ht(2761748,{roughness:.7}));g.position.set(0,1.42,.14),s.add(g);let x=new W(new jt(.018,8,6),new Qt({color:3348480,emissive:16746496,emissiveIntensity:.12,roughness:.4}));x.position.set(.3,1.52,.15),s.add(x);let m=new Qt({map:i[e%i.length],emissive:16777215,emissiveMap:i[e%i.length],emissiveIntensity:.12,color:4868682,roughness:.38,metalness:.05}),f=new W(new me(.42,.62),m);return f.position.set(0,1.82,.162),s.add(f),s.position.set(n,0,t),s.rotation.y=Math.atan2(Lf.x-n,Lf.z-t),{group:s,screenMat:m,ledMat:x.material,frame:e%i.length}}function Uf(n){let t=[],e=[],i=HM(()=>{for(let o of t){let a=i[o.frame];o.screenMat.map=a,o.screenMat.emissiveMap=a}});OM.forEach(([o,a],c)=>{let l=zM(o,a,c,i),h=document.createElement("video");h.src=If[c%If.length],h.loop=!0,h.muted=!0,h.playsInline=!0,h.preload="metadata",h.setAttribute("playsinline","");let u=new Ao(h);u.colorSpace=te,l.video=h,l.videoTex=u,l.stillTex=i[c%i.length],n.add(l.group),t.push(l),e.push({position:new C(o,0,a),radius:Er})});let s=new It(3815994),r=new It(16777215);return{spots:e,tick(o,a=!0){let c=performance.now(),l=-1,h=Er*Er;for(let u=0;u<t.length;u++){let d=e[u].position,p=(o.x-d.x)**2+(o.z-d.z)**2;p<h&&(h=p,l=u)}for(let u=0;u<t.length;u++){let d=t[u],p=e[u].position,g=o.x-p.x,x=o.z-p.z,m=g*g+x*x<Er*Er,f=d.screenMat,y=m?.92:.1;f.emissiveIntensity+=(y-f.emissiveIntensity)*.12,f.color.lerp(m?r:s,.12),d.ledMat.emissiveIntensity+=((m?1.4:.1)-d.ledMat.emissiveIntensity)*.14,m?(d.videoTex&&f.map!==d.videoTex&&(f.map=d.videoTex,f.emissiveMap=d.videoTex),d.video&&d.video.paused&&d.video.play().catch(()=>{}),d.video&&(d.video.muted=!a||u!==l,d.video.volume=.45)):d.video&&!d.video.paused&&(d.video.pause(),d.video.muted=!0,d.stillTex&&(f.map=d.stillTex,f.emissiveMap=d.stillTex))}}}}function kM(n,t){return Math.hypot(n.x-t.x,n.z-t.z)}function Nf({carpenter:n,shades:t,locals:e=[]}={}){let i=null;function s(){let a=new Set;n&&a.add(n),t&&a.add(t);for(let c of e)c?.bed&&a.add(c.bed);return a}function r(a){return a.radius!=null?a.radius:t&&a.bed===t?12:0}function o(a){if(a===i)return;i=a;let c=s();if(a==="mute"){for(let h of c)h.setMix?.(0,.65);return}let l=n;a!=="carpenter"&&(l=e.find(u=>u.id===a)?.bed||n);for(let h of c)h.setMix?.(h===l?1:0,.65)}return{tick(a,c){if(!c||!a){o("mute");return}let l=null,h=1/0;for(let u of e){if(!u?.getPos||!u.bed)continue;let d=u.getPos();if(!d)continue;let p=kM(a,d);p<r(u)&&p<h&&(h=p,l=u)}o(l?l.id:"carpenter")}}}var Dn=n=>440*2**((n-69)/12);function kn(n,t,e){let i=n.createOscillator();return i.type=t,i.frequency.value=e,i}function Je(n,t){let e=n.createGain();return e.gain.value=t,e}function ia(n,t,e,i){let s=n.createBiquadFilter();return s.type=t,s.frequency.value=e,i!=null&&(s.Q.value=i),s}function gl(n,t,e,i){n.cancelScheduledValues(i),n.setValueAtTime(n.value,i),n.linearRampToValueAtTime(t,i+e)}function Of(n,t){let e=Math.max(1,n.sampleRate*t|0),i=n.createBuffer(1,e,n.sampleRate),s=i.getChannelData(0);for(let r=0;r<e;r++)s[r]=Math.random()*2-1;return i}function br(n,t,e,i,s){let r=Je(n,1e-4);return r.gain.setValueAtTime(1e-4,t),r.gain.exponentialRampToValueAtTime(e,t+i),r.gain.exponentialRampToValueAtTime(1e-4,t+s),r}function xl(n,t,e){let i=Je(n,0);i.connect(t||n.destination);let s=!1,r=0,o=0,a=0,c=0;return{out:i,get running(){return s},start(l){n.state==="suspended"&&n.resume(),!s&&(s=!0,a=0,o=n.currentTime+.06,gl(i.gain,e*c,.08,n.currentTime),l())},setMix(l,h=.6){c=Math.max(0,Math.min(1,l)),gl(i.gain,e*c,h,n.currentTime)},stop(){s=!1,clearTimeout(r),gl(i.gain,0,.08,n.currentTime)},clock(l,h,u){if(!s)return;let d=n.currentTime+l;for(;o<d;)u(o,a++),o+=h;r=setTimeout(()=>this.clock(l,h,u),35)}}}function Ff(n,t,e,i=148,s=41,r=.72,o=.22){let a=kn(n,"sine",i);a.frequency.setValueAtTime(i,e),a.frequency.exponentialRampToValueAtTime(s,e+.11);let c=br(n,e,r,.004,o);a.connect(c).connect(t),a.start(e),a.stop(e+o+.02)}function na(n,t,e,i,s,r,o){let a=n.createBufferSource();a.buffer=e;let c=ia(n,"highpass",o,.7),l=br(n,i,s,.002,r);a.connect(c).connect(l).connect(t),a.start(i),a.stop(i+r+.02)}function Bf(n,t){let s=xl(n,t,.48),r=Je(n,1),o=Je(n,.7),a=Je(n,.45),c=Je(n,.28);r.connect(s.out),o.connect(s.out),a.connect(s.out),c.connect(s.out);let l=Of(n,.06),h=kn(n,"triangle",Dn(36)),u=ia(n,"lowpass",280,1.1),d=Je(n,1e-4);h.connect(d).connect(u).connect(a);let p=!1;function g(m,f){let y=kn(n,"sine",Dn(f)),_=kn(n,"sine",Dn(f+7));_.detune.value=4;let E=br(n,m,.16,.01,.28);y.connect(E),_.connect(E),E.connect(c),y.start(m),y.stop(m+.3),_.start(m),_.stop(m+.3)}function x(m,f){let y=f&15;(y&3)===0&&Ff(n,r,m,142,40,.78,.2),na(n,o,l,m,y&1?.05:.14,y&1?.035:.048,7200),(y===6||y===14)&&na(n,o,l,m,.18,.16,4800);let E=Dn([36,36,39,43][y>>2&3]);h.frequency.setValueAtTime(E,m),d.gain.cancelScheduledValues(m),d.gain.setValueAtTime(1e-4,m),(y&3)===0&&(d.gain.exponentialRampToValueAtTime(.55,m+.012),d.gain.exponentialRampToValueAtTime(1e-4,m+.18)),(y===4||y===12)&&g(m,y===4?79:76),y===10&&g(m,72)}return{start(){p||(h.start(),p=!0),s.start(()=>s.clock(.12,15/118,x))},setMix:(m,f)=>s.setMix(m,f),stop:()=>s.stop()}}function Hf(n,t){let i=[52,59,55,62,47,55,64,59,52,50,55,62],s=xl(n,t,.42),r=Je(n,.85),o=ia(n,"lowpass",2400,.6),a=n.createDelay(.45);a.delayTime.value=.28;let c=Je(n,.28);r.connect(o).connect(s.out),o.connect(a).connect(c).connect(a),a.connect(s.out);let l=kn(n,"sine",Dn(40)),h=Je(n,.05);l.connect(h).connect(o);let u=!1;function d(g,x){let m=kn(n,"sine",Dn(x)),f=kn(n,"triangle",Dn(x));f.detune.value=6;let y=br(n,g,.22,.012,1.8);if(m.connect(y),f.connect(y),y.connect(r),m.start(g),m.stop(g+1.9),f.start(g),f.stop(g+1.9),x>=55&&x&1){let _=kn(n,"sine",Dn(x+7)),E=br(n,g,.08,.02,1.4);_.connect(E).connect(r),_.start(g),_.stop(g+1.5)}}function p(g,x){d(g,i[x%i.length])}return{start(){u||(l.start(),u=!0),s.start(()=>s.clock(.2,.92,p))},setMix:(g,x)=>s.setMix(g,x),stop:()=>s.stop()}}function zf(n,t){let s=xl(n,t,.44),r=Je(n,.7),o=Je(n,.55),a=Je(n,.35);r.connect(s.out),o.connect(s.out),a.connect(s.out);let c=Of(n,.04),l=kn(n,"sawtooth",Dn(28)),h=kn(n,"square",Dn(28));l.detune.value=3,h.detune.value=-5;let u=Je(n,.32),d=Je(n,1e-4),p=ia(n,"lowpass",520,1.8);l.connect(d),h.connect(u).connect(d),d.connect(p).connect(r);let g=!1;function x(m,f){let y=f>>3&7,_=f&7,E=Dn(y>=4?31:28);l.frequency.setValueAtTime(E,m),h.frequency.setValueAtTime(E*.997,m);let R=_&1;d.gain.cancelScheduledValues(m),d.gain.setValueAtTime(1e-4,m),d.gain.exponentialRampToValueAtTime(R?.12:.5,m+.01),d.gain.exponentialRampToValueAtTime(1e-4,m+(R?.06:.12)),R||(p.frequency.setValueAtTime(720,m),p.frequency.setTargetAtTime(480,m+.02,.05)),na(n,o,c,m,R?.07:.12,R?.03:.045,8e3),na(n,o,c,m+15/124,.045,.025,9e3),(_===2||_===6)&&Ff(n,a,m,210,90,.18,.06)}return{start(){g||(l.start(),h.start(),g=!0),s.start(()=>s.clock(.12,30/124,x))},setMix:(m,f)=>s.setMix(m,f),stop:()=>s.stop()}}var GM=725520;Bu();ku();Hu();var bl=document.getElementById("game"),Ki=new nr({canvas:bl,antialias:!0,alpha:!1,powerPreference:"high-performance"});Ki.setClearColor(GM,1);Ki.outputColorSpace=te;Ki.shadowMap.enabled=!0;Ki.shadowMap.type=Bc;var bn=new Oi;wd(bn);var Ns=new Ue(62,1,.08,220),VM=od(),Gf=td(),vl=Td(bn,Gf),ge=Qu({x:0,y:0,z:10});ge.yaw=0;var Os=Cd();bn.add(Os);var Sl=Ud(bn),wl=vf(bn),WM=Pf(bn),XM=Uf(bn),qM=gf(bn);for(let n of wl.musicSpots)n.id.startsWith("guitar")&&n.position&&Sl.push({mesh:{position:n.position},kind:"ken",ageBand:"adult"});var pn=new qo;pn.loadManifest().catch(()=>{});var Fs=new Yo,YM=Vu(Fs,null),ZM=Ju(Fs),Ml=Bd(pn,Sl),_l=Kd();ll(Os);var El=cf();document.body.appendChild(El.html);var Vf=tf({scene:bn,play:n=>pn.play(n),onGameOver:()=>{Un=!1,Gn?.setState("menu")}}),Wf=null;window.addEventListener("keydown",n=>{!Un||si||n.code==="KeyF"&&(n.preventDefault(),Vf.tryFire("laser"))});var Gn=null,kf=null,Sr=null,Xf=null,sa=null,wr=null,ra=null,Un=!1,si=!1,yl=0,qf=new Ho(!1),Tr=ed({dom:bl,isPlaying:()=>Un&&!si,onEscapePause:()=>{Un&&!si&&(si=!0,JM.showAsPause(),Gn?.setState("menu"),document.pointerLockElement&&document.exitPointerLock())}});Tr.bindPlayer(ge);fd({keys:Tr.keys,isPlaying:()=>Un&&!si});function Tl(){let{w:n,h:t}=zu(Ki,bl);Ns.aspect=n/Math.max(1,t),Ns.updateProjectionMatrix()}Tl();window.addEventListener("resize",Tl);window.addEventListener("orientationchange",()=>setTimeout(Tl,300));var Vn=!0;window.addEventListener("keydown",n=>{n.code==="KeyM"&&Un&&(Vn=!Vn,pn.gain&&(pn.gain.gain.value=Vn?.5:0),Fs.master&&(Fs.master.gain.value=Vn?.85:0))});async function KM(){Un=!0,si=!1,qf.start(),VM.snap(),Tr.tryLock();try{await pn.unlock(),await Fs.unlock();let n=pn.ctx||Fs.ctx;if(n&&!Gn){Gn=Wu(n),kf=Xu(n),Sr=md(n),Sr.start(),Sr.setMix(0,.05),sa=Bf(n),wr=Hf(n),ra=zf(n),sa.start(),wr.start(),ra.start(),sa.setMix(0,.05),wr.setMix(0,.05),ra.setMix(0,.05);let t=wl.musicSpots,e=i=>t.find(s=>s.id===i);Wf=hf({carpenter:Gn,voice:pn,isTalking:i=>Ml.isTalking(i??performance.now())}),Xf=Nf({carpenter:Gn,shades:Sr,locals:[{id:"piano",getPos:()=>vl.piano,radius:12,bed:Sr},{id:"dj",getPos:()=>e("dj")?.position||{x:-24,z:7},radius:10,bed:ra},{id:"boombox",getPos:()=>e("boombox")?.position,radius:8,bed:sa},{id:"guitar-a",getPos:()=>e("guitar-a")?.position,radius:7,bed:wr},{id:"guitar-b",getPos:()=>e("guitar-b")?.position,radius:7,bed:wr}]})}Gn?.setState("boardwalk"),Gn?.start(),kf?.start(),Vn&&(await pn.preload(["dj_open_01","gold_coast_lad_01","walkby_flirt_01","walkby_heckle_01","ken_gossip_steaks_beach","babe_gossip_botox_map","interject_oi_01","gull_01","goth_01"]),await pn.play("dj_open_01").ready)}catch(n){console.warn("audio",n)}}var $M=new Xo({onDone:()=>KM()}),JM=new Wo({onStart:async()=>{try{await pn.unlock(),Vn&&await pn.play("factory_recall_01").ready}catch{}$M.start()}}),jM=new Rs().load("assets/media/ads/billboard_terminate_uv.png",n=>{n.colorSpace=te}),Al=new W(new me(9.2,5.2),new le({map:jM}));Al.position.set(0,6.4,Ft.boardwalkZ-5.5);Al.rotation.y=Math.PI;bn.add(Al);function Yf(){requestAnimationFrame(Yf);let n=si||!Un?0:Math.min(.05,qf.getDelta());for(yl+=n;yl>=hn;){if(Un&&!si){let t=pd();t.mag>.04&&(ge.yaw-=t.x*2.35*hn,ge.pitch-=t.y*1.55*hn,ge.pitch=Math.max(-1.45,Math.min(1.45,ge.pitch))),nd(ge,Tr.keys,Gf.COL,nl,hn)}yl-=hn}if(Un&&!si){let t=performance.now()*.001;vl.update(t),wl.tick(t),WM.tick(n||hn),XM.tick(ge.pos,Vn),Wf?.tick?.(),Vf.tick(n||hn,ge.pos);let e=Math.hypot(ge.vel.x,ge.vel.z);Os.position.set(ge.pos.x,ge.pos.y,ge.pos.z),Os.rotation.y=ge.yaw+Math.PI,il(Os,{walkPhase:ge.step,speed:e}),ad(Ns,ge,n||.016),YM.tick(performance.now(),e>.4),ZM.tick({speed:e,onWood:vl.isWood(ge.pos.x,ge.pos.z),dt:n||hn});let i=!!Tr.keys.Space;i?Gn?.setState("apply"):Gn?.setState("boardwalk");let s=_l.canPaint()?Zd(Sl,ge.pos,i,n||hn,ge.yaw):null;s&&El.track(s.npc),El.tick(n||hn,s?.npc),_l.tick({squeezeHeld:i,applying:!!s,dt:n||hn}),$d(Os,_l,n||hn),s&&Vn&&!Ml.isTalking(performance.now())&&Math.random()<.012&&pn.play("rub_pleasure_01",{gain:1.2}),Vn&&Ml.tick(performance.now(),ge.pos),Xf?.tick(ge.pos,Vn),qM.tick(Ki,bn,performance.now())}else Un||(Ns.position.set(8,6.5,22),Ns.lookAt(0,1.2,4));Ki.render(bn,Ns)}Yf();
