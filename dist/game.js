...
`.trim(),document.head.appendChild(n)}function $f(n,t,e){let i=document.createElement(n);return t&&(i.className=t),e&&e.appendChild(i),i}function Jf(n={}){wM();let t=$f("div");t.id="aus101-reticule",t.setAttribute("aria-label","Reticule bay");let e=[],i=[],s=0,r=-1;for(let p=0;p<Xf;p++){e.push({id:p,kind:null,mesh:null,coverage:0,dose:0,burn:!1,applying:!1,_seq:0,_prevCov:0});let g=$f("div","aus101-ret-slot is-empty",t);g.dataset.slot=String(p),g.addEventListener("pointerdown",x=>{let f=e[p];f.mesh&&(x.preventDefault(),x.stopPropagation(),r=p,n.onSelect?.(f),t.dispatchEvent(new CustomEvent("aus101-reticule-select",{detail:f})),c())}),i.push(g)}function o(p){let g=SM(p.id+1);if(!p.mesh)return`SUBJECT ${g} // \u2014\u2014`;if(p.burn||p.dose>1)return`SUBJECT ${g} // BURN`;let x=Math.max(0,Math.round((1-p.dose)*100));return`SUBJECT ${g} // TELOMERE ${x}%`}function a(p){let g=e[p],x=i[p];x.textContent=o(g);let f=!!g.mesh;x.className="aus101-ret-slot",f?x.classList.add("is-live"):x.classList.add("is-empty"),f&&(g.burn||g.dose>1)?x.classList.add("is-burn"):f&&g.coverage>=qf&&x.classList.add("is-locked"),f&&g.applying&&x.classList.add("is-applying"),f&&r===p&&x.classList.add("is-sel")}function c(){for(let p=0;p<Xf;p++)a(p)}function l(p,g){let x=Ur(g),f=x.userData||(x.userData={});p.kind=Kf(g),p.mesh=x,p.coverage=Zf(g),p.dose=Number.isFinite(f.dose)?f.dose:0,p.burn=p.dose>1||!!f.burn,p.applying=!1,p._seq=++s,p._prevCov=p.coverage,f.dose=p.dose,p.burn&&(f.burn=!0),a(p.id)}function h(p){p.kind=null,p.mesh=null,p.coverage=0,p.dose=0,p.burn=!1,p.applying=!1,p._seq=0,p._prevCov=0,r===p.id&&(r=-1),a(p.id)}function u(p){if(!bM(p))return null;let g=Ur(p),x=e.find(m=>m.mesh===g);if(x)return x;let f=e.find(m=>!m.mesh);return f||(f=e.reduce((m,y)=>m._seq<=y._seq?m:y),h(f)),l(f,p),f}function d(p,g){let x=Ur(g),f=Number.isFinite(p)?Math.max(0,p):0;for(let m of e){if(!m.mesh)continue;let y=Zf(m.mesh);m.coverage=y;let _=y>m._prevCov+1e-5,v=x===m.mesh||_;m.applying=v,m._prevCov=y,y<qf&&!v&&(m.dose+=(1-y)*f*EM),m.dose>1&&(m.burn=!0);let R=m.mesh.userData||(m.mesh.userData={});R.coverage=y,R.dose=m.dose,m.burn&&(R.burn=!0),a(m.id)}}return c(),{track:u,tick:d,html:t,slots:e}}var Nr=["boardwalk","apply","menu"],TM=["dj_song_01","dj_song_02","dj_song_03"];function AM(n){return n<10?`0${n}`:String(n)}function RM(){let n=t=>typeof matchMedia=="function"?matchMedia(t).matches:!1;return typeof matchMedia!="function"?"ontouchstart"in window:!!(n("(pointer: coarse)")||n("(any-pointer: coarse)")||"ontouchstart"in window&&n("(hover: none)"))}function CM(){return typeof matchMedia=="function"&&matchMedia("(orientation: landscape)").matches?!0:window.innerWidth>window.innerHeight}function _n(n,t,e){let i=document.createElement(n);return t&&Object.assign(i.style,t),e&&e.appendChild(i),i}function PM(n,t){let e=t>>>0||1,i=n.slice();for(let s=i.length-1;s>0;s--){e=Math.imul(e,1664525)+1013904223>>>0;let r=e%(s+1),o=i[s];i[s]=i[r],i[r]=o}return i}function LM(n){if(!n||n===document.body||n===document.documentElement)return!1;let t=(n.tagName||"").toLowerCase();return t==="input"||t==="textarea"||t==="select"?!0:!!n.isContentEditable}function IM(){let n=_n("span",{display:"flex",alignItems:"center",gap:"1px"});return _n("span",{width:"2px",height:"10px",background:"currentColor",borderRadius:"1px"},n),_n("span",{width:"0",height:"0",borderStyle:"solid",borderWidth:"5px 8px 5px 0",borderColor:"transparent currentColor transparent transparent"},n),n}function DM(){let n=_n("span",{display:"flex",alignItems:"center",gap:"1px"});return _n("span",{width:"0",height:"0",borderStyle:"solid",borderWidth:"5px 0 5px 8px",borderColor:"transparent transparent transparent currentColor"},n),_n("span",{width:"2px",height:"10px",background:"currentColor",borderRadius:"1px"},n),n}function jf(){let n=_n("span",{display:"flex",alignItems:"center",gap:"3px"}),t=()=>_n("span",{width:"3px",height:"10px",background:"currentColor",borderRadius:"1px"},n);return t(),t(),n}function UM(){return _n("span",{width:"0",height:"0",marginLeft:"2px",borderStyle:"solid",borderWidth:"6px 0 6px 9px",borderColor:"transparent transparent transparent currentColor"})}function zl(n,t){let e=_n("button",{width:"26px",height:"26px",borderRadius:"50%",padding:"0",margin:"0",border:"1px solid rgba(251,246,234,0.28)",background:"rgba(12,18,16,0.42)",color:"rgba(251,246,234,0.92)",boxShadow:"inset 0 0 0 1px rgba(0,0,0,0.18), 0 3px 12px rgba(0,0,0,0.28)",display:"flex",alignItems:"center",justifyContent:"center",pointerEvents:"auto",touchAction:"none",cursor:"pointer",appearance:"none",webkitAppearance:"none",outline:"none",backdropFilter:"blur(8px)",webkitBackdropFilter:"blur(8px)",userSelect:"none",webkitUserSelect:"none"});return e.type="button",e.tabIndex=-1,e.setAttribute("aria-label",t),e.appendChild(n),e}function NM(){let n=[];for(let t=1;t<=49;t++)n.push(`dj_quip_${AM(t)}`);return PM(n,performance.now()*997|0)}function Qf({carpenter:n,voice:t,isTalking:e}={}){let i=Nr.indexOf(n?.state);i<0&&(i=0);let s=n?n.running===!1:!1,r=1,o=!1,a=[],c=!1,l=null;if(!document.getElementById("aus101-radio-css")){let O=document.createElement("style");O.id="aus101-radio-css",O.textContent="#aus101-radio,#aus101-radio *{box-sizing:border-box;-webkit-tap-highlight-color:transparent;}#aus101-radio button:active{background:rgba(255,215,106,0.28)!important;}#aus101-radio .radio-vol{-webkit-appearance:none;appearance:none;width:56px;height:18px;background:transparent;padding:0;margin:0 2px 0 0;cursor:pointer;}#aus101-radio .radio-vol::-webkit-slider-runnable-track{height:3px;border-radius:2px;background:rgba(251,246,234,0.28);}#aus101-radio .radio-vol::-webkit-slider-thumb{-webkit-appearance:none;width:10px;height:10px;border-radius:50%;background:#ffd76a;margin-top:-3.5px;border:0;}#aus101-radio .radio-vol::-moz-range-track{height:3px;border-radius:2px;background:rgba(251,246,234,0.28);}#aus101-radio .radio-vol::-moz-range-thumb{width:10px;height:10px;border-radius:50%;background:#ffd76a;border:0;}#aus101-radio[data-touch='1'] .radio-vol{display:none;}",document.head.appendChild(O)}let h=_n("div",{position:"fixed",zIndex:"12",pointerEvents:"none",userSelect:"none",webkitUserSelect:"none",touchAction:"none"});h.id="aus101-radio",h.setAttribute("role","group"),h.setAttribute("aria-label","Reticule FM 101.7");let u=_n("div",{display:"flex",alignItems:"center",gap:"8px",pointerEvents:"auto",touchAction:"none"},h),d=document.createElement("input");d.type="range",d.className="radio-vol",d.min="0",d.max="1",d.step="0.01",d.value="1",d.tabIndex=-1,d.setAttribute("aria-label","Volume"),u.appendChild(d);let p=zl(IM(),"Previous"),g=zl(jf(),"Pause"),x=zl(DM(),"Next"),f=_n("span",{position:"absolute",width:"5px",height:"5px",borderRadius:"50%",right:"3px",top:"3px",background:"#ffd76a",boxShadow:"0 0 6px rgba(255,215,106,0.7)",pointerEvents:"none"});g.style.position="relative",g.appendChild(f),u.append(p,g,x);function m(){if(t?.busy)return!0;if(typeof e=="function")try{if(e(performance.now()))return!0}catch{}return!1}function y(){return a.length||(a=NM()),a.pop()}function _(){if(typeof t?.play!="function"){o=!1;return}if(m()){o=!0;return}o=!1;let O=TM[i]||"dj_song_01",q=t.play(O);q.ready?.then(W=>{if(!W){o=!0;return}let G=q.onended;q.onended=()=>{if(typeof G=="function"&&G(),m())return;let k=y();k&&t.play(k)}})}function v(O){r=Math.max(0,Math.min(1,O)),d.value!==String(r)&&(d.value=String(r)),n?.setMix?.(r)}function R(){g.replaceChildren(s?UM():jf(),f),g.setAttribute("aria-label",s?"Play":"Pause"),g.setAttribute("aria-pressed",s?"true":"false")}function T(){let O=["#ffd76a","#fbf6ea","#ff6a4a"];f.style.background=O[i]||O[0],f.style.boxShadow=`0 0 6px ${O[i]||O[0]}`}function w(O){n?.setState?.(Nr[i]),s||(n?.start?.(),n?.setMix?.(r)),T(),O&&_()}function U(O){i=(i+O+Nr.length)%Nr.length,w(!0)}function M(){s=!s,s?n?.stop?.():(n?.setState?.(Nr[i]),n?.start?.(),n?.setMix?.(r)),R()}function b(){let q=CM()?"max(20px, calc(env(safe-area-inset-top, 0px) + 4px))":"max(12px, calc(env(safe-area-inset-top, 0px) + 6px))";h.style.top=q,h.style.right="max(10px, env(safe-area-inset-right, 0px))",h.dataset.touch=RM()?"1":"0"}let P=O=>{if(c||O.metaKey||O.ctrlKey||O.altKey||LM(O.target))return;let q=O.code,W=O.key;if(q==="Minus"||q==="NumpadSubtract"||W==="-"||W==="_"){v(r-.06),O.preventDefault();return}if(q==="Equal"||q==="NumpadAdd"||W==="="||W==="+"){v(r+.06),O.preventDefault();return}if(!O.repeat){if(q==="BracketLeft"||W==="["||q==="Comma"||W===","){U(-1),O.preventDefault();return}if(q==="BracketRight"||W==="]"||q==="Period"||W==="."){U(1),O.preventDefault();return}(q==="KeyP"||W==="p"||W==="P")&&(M(),O.preventDefault())}},z=()=>v(parseFloat(d.value)),F=O=>{if(!(O.pointerType==="mouse"&&O.button!==0)&&O.target!==d){l={id:O.pointerId,y:O.clientY,vol:r,moved:!1};try{u.setPointerCapture(O.pointerId)}catch{}}},C=O=>{if(!l||O.pointerId!==l.id)return;let q=l.y-O.clientY;Math.abs(q)>7&&(l.moved=!0),l.moved&&v(l.vol+q/140)},D=O=>{if(!l||O.pointerId!=null&&O.pointerId!==l.id)return;let q=l.moved;l=null,q&&(O.preventDefault(),O.stopPropagation())};function B(O,q){O.addEventListener("pointerup",W=>{l?.moved||(W.preventDefault(),W.stopPropagation(),q())}),O.addEventListener("click",W=>{W.preventDefault(),W.stopPropagation()})}return B(p,()=>U(-1)),B(g,()=>M()),B(x,()=>U(1)),d.addEventListener("input",z),d.addEventListener("change",z),u.addEventListener("pointerdown",F),u.addEventListener("pointermove",C),u.addEventListener("pointerup",D),u.addEventListener("pointercancel",D),window.addEventListener("keydown",P),window.addEventListener("resize",b),window.addEventListener("orientationchange",b),b(),R(),T(),document.body.appendChild(h),{el:h,tick(){c||(b(),o&&!m()&&_())},dispose(){c||(c=!0,o=!1,window.removeEventListener("keydown",P),window.removeEventListener("resize",b),window.removeEventListener("orientationchange",b),d.removeEventListener("input",z),d.removeEventListener("change",z),u.removeEventListener("pointerdown",F),u.removeEventListener("pointermove",C),u.removeEventListener("pointerup",D),u.removeEventListener("pointercancel",D),h.remove())}}}var tp="aus101-apply-mg-css",Gl={r:243,g:239,b:228},Vl={r:58,g:36,b:24},ep=.22,Wl=.45,OM=3.6,np=1.15,ip={head:{u:.5,v:.15},torso:{u:.5,v:.4},armL:{u:.2,v:.38},armR:{u:.8,v:.38},legL:{u:.35,v:.65},legR:{u:.65,v:.65}},BM=["head","armL","armR","torso","legL","legR"];function sp(n){return n?n.mesh||n:null}function ya(n){return n<0?0:n>1?1:n}function Xl(n,t,e){return n+(t-n)*e+.5|0}function FM(n){let t=ya(n);return`rgb(${Xl(Vl.r,Gl.r,t)},${Xl(Vl.g,Gl.g,t)},${Xl(Vl.b,Gl.b,t)})`}function kM(){return typeof Lr=="function"?Lr:null}function HM(n){if(typeof Xn=="function"){let e=Xn(n);if(Number.isFinite(e))return ya(e)}let t=sp(n)?.userData?.coverage;return Number.isFinite(t)?ya(t):0}function zM(n,t,e,i){let s=n.size,r=n.data;if(!s||!r)return 0;let o=Math.max(1,i*s),a=(t%1+1)%1*s,c=Math.min(1,Math.max(0,e))*s,l=o*o,h=Math.floor(a-o),u=Math.ceil(a+o),d=Math.max(0,Math.floor(c-o)),p=Math.min(s-1,Math.ceil(c+o)),g=0,x=0;for(let f=d;f<=p;f++){let m=f+.5-c;for(let y=h;y<=u;y++){let _=y+.5-a;if(_*_+m*m>l)continue;let v=(y%s+s)%s;g+=r[f*s+v],x++}}return x?g/(x*255):0}function GM(n,t){let e=ip[t],i=sp(n)?.userData?.coverageMap;return i&&e?ya(zM(i,e.u,e.v,.1)):HM(n)}function Ri(n,t,e,i,s,r){let o=i-t,a=s-e,c=Math.hypot(o,a)||1,l=-a/c*r,h=o/c*r,u=Math.atan2(h,l),d=u+Math.PI;n.moveTo(t+l,e+h),n.lineTo(i+l,s+h),n.arc(i,s,r,u,d),n.lineTo(t-l,e-h),n.arc(t,e,r,d,u),n.closePath()}function VM(n,t){let e=n/200,i=t/360,s=p=>p*e,r=p=>p*i,o=p=>p*Math.min(e,i),a=new Path2D;a.ellipse(s(100),r(48),s(26),r(30),0,0,Math.PI*2);let c=new Path2D;c.moveTo(s(88),r(76)),c.bezierCurveTo(s(78),r(78),s(66),r(84),s(58),r(96)),c.lineTo(s(62),r(198)),c.quadraticCurveTo(s(64),r(216),s(78),r(222)),c.lineTo(s(122),r(222)),c.quadraticCurveTo(s(136),r(216),s(138),r(198)),c.lineTo(s(142),r(96)),c.bezierCurveTo(s(134),r(84),s(122),r(78),s(112),r(76)),c.closePath();let l=new Path2D;Ri(l,s(56),r(100),s(40),r(168),o(9)),Ri(l,s(40),r(168),s(34),r(230),o(7.5)),l.ellipse(s(32),r(242),o(8),o(9),0,0,Math.PI*2);let h=new Path2D;Ri(h,s(144),r(100),s(160),r(168),o(9)),Ri(h,s(160),r(168),s(166),r(230),o(7.5)),h.ellipse(s(168),r(242),o(8),o(9),0,0,Math.PI*2);let u=new Path2D;Ri(u,s(84),r(222),s(78),r(282),o(12)),Ri(u,s(78),r(282),s(76),r(336),o(10)),u.ellipse(s(70),r(344),s(16),r(7),0,0,Math.PI*2);let d=new Path2D;return Ri(d,s(116),r(222),s(122),r(282),o(12)),Ri(d,s(122),r(282),s(124),r(336),o(10)),d.ellipse(s(130),r(344),s(16),r(7),0,0,Math.PI*2),{head:a,torso:c,armL:l,armR:h,legL:u,legR:d}}function WM(){if(typeof document>"u"||document.getElementById(tp))return;let n=document.createElement("style");n.id=tp,n.textContent=`
#aus101-apply-mg{
  position:fixed;
  inset:0;
  z-index:16;
...
`.trim(),document.head.appendChild(n)}function rp({onStamp:n}={}){WM();let t=document.createElement("div");t.id="aus101-apply-mg",t.setAttribute("aria-hidden","true"),t.setAttribute("aria-label","Coverage map");let e=document.createElement("div");e.className="aus101-apply-card",t.appendChild(e);let i=document.createElement("canvas");e.appendChild(i);let s=i.getContext("2d"),r=null,o=!1,a=null,c=0,l=0,h=null,u={down:!1,id:-1,region:null,lastT:0},d={x:0,y:0,on:!1};function p(){let F=Math.min(window.devicePixelRatio||1,2),C=Math.max(1,i.clientWidth||e.clientWidth||160),D=Math.max(1,i.clientHeight||e.clientHeight||280),B=Math.max(1,Math.round(C*F)),O=Math.max(1,Math.round(D*F));return(i.width!==B||i.height!==O)&&(i.width=B,i.height=O,a=null),(!a||c!==B||l!==O)&&(a=VM(B,O),c=B,l=O,d.on||(d.x=B*.5,d.y=O*.4)),{w:B,h:O}}function g(F,C){if(!a||!s)return null;for(let D of BM)if(s.isPointInPath(a[D],F,C))return D;return null}function x(F){let C=i.getBoundingClientRect(),D=C.width||1,B=C.height||1;return{x:(F.clientX-C.left)/D*c,y:(F.clientY-C.top)/B*l}}function f(){if(!s||!o)return;let{w:F,h:C}=p();s.clearRect(0,0,F,C),s.fillStyle="rgba(8,10,8,0.2)",s.beginPath(),s.ellipse(F*.5,C*.96,F*.28,C*.03,0,0,Math.PI*2),s.fill();let D=["legL","legR","armL","armR","torso","head"];for(let O of D){let q=r?GM(r,O):0;if(s.fillStyle=FM(q),s.fill(a[O]),q>.08){s.save(),s.clip(a[O]);let W=s.createLinearGradient(0,0,0,C*.5);W.addColorStop(0,`rgba(255,255,248,${.14+q*.22})`),W.addColorStop(1,"rgba(255,255,248,0)"),s.fillStyle=W,s.fillRect(0,0,F,C),s.restore()}}s.lineJoin="round",s.lineCap="round",s.strokeStyle="rgba(251,246,234,0.28)",s.lineWidth=Math.max(1,F/200);for(let O of D)s.stroke(a[O]);let B=u.region||h;if(B&&a[B]&&(s.strokeStyle="rgba(224,176,64,0.95)",s.lineWidth=Math.max(1.5,F/110),s.stroke(a[B])),d.on){let O=Math.max(7,F*.035);s.beginPath(),s.arc(d.x,d.y,O,0,Math.PI*2),s.fillStyle="rgba(243,239,228,0.88)",s.fill(),s.strokeStyle="rgba(224,176,64,0.95)",s.lineWidth=Math.max(1.5,F/140),s.stroke()}}function m(F,C){if(!r||!F||!(C>0))return;let D=ip[F];if(!D)return;let B=kM();B&&(B(r,D.u,D.v,ep,C),typeof Ir=="function"&&Ir(r)),n?.({npc:r,u:D.u,v:D.v,radius:ep,amount:C,region:F})}function y(F,C,D){let B=g(F,C);return u.region=B,h=B,B&&m(B,D),B}function _(F,C){let D=x(F);y(D.x,D.y,C),f()}function v(){if(!u.down||!u.region)return;let F=performance.now(),C=Math.min(.05,Math.max(0,(F-u.lastT)/1e3));u.lastT=F,C>0&&m(u.region,OM*C)}function R(F){if(o&&!(F.pointerType==="mouse"&&F.button!==0)){F.preventDefault(),F.stopPropagation(),u.down=!0,u.id=F.pointerId,u.lastT=performance.now();try{i.setPointerCapture(F.pointerId)}catch{}_(F,Wl)}}function T(F){if(!o)return;let C=x(F),D=g(C.x,C.y);if(u.down&&(u.id===-1||F.pointerId===u.id)){F.preventDefault(),F.stopPropagation();let B=u.region;u.region=D,h=D,d.x=C.x,d.y=C.y,d.on=!0,D&&D!==B&&m(D,Wl),v(),f();return}h!==D&&(h=D,f())}function w(F){if(!(u.id!==-1&&F.pointerId!==u.id)&&(u.down=!1,u.id=-1,u.region=null,u.lastT=0,o)){let C=x(F);h=g(C.x,C.y),f()}}function U(F){if(!o||!r||typeof document>"u"||!document.pointerLockElement)return;(!c||!l)&&p(),d.x=Math.max(0,Math.min(c,d.x+F.movementX*np)),d.y=Math.max(0,Math.min(l,d.y+F.movementY*np)),d.on=!0;let C=u.region,D=g(d.x,d.y);u.region=D,h=D,u.lastT||(u.lastT=performance.now()),D&&D!==C&&m(D,Wl),v(),f()}function M(F){F.stopPropagation()}i.addEventListener("pointerdown",R),i.addEventListener("pointermove",T),i.addEventListener("pointerup",w),i.addEventListener("pointercancel",w),i.addEventListener("lostpointercapture",w),i.addEventListener("contextmenu",F=>F.preventDefault()),e.addEventListener("mousedown",M),e.addEventListener("pointerdown",M),window.addEventListener("pointermove",F=>{u.down&&T(F)}),window.addEventListener("pointerup",w),window.addEventListener("pointercancel",w),document.addEventListener("mousemove",U),window.addEventListener("resize",()=>{o&&f()});function b(F){if(!F){P();return}r=F,o=!0,t.classList.add("is-on"),t.setAttribute("aria-hidden","false"),p(),d.on||(d.x=c*.5,d.y=l*.4),f(),requestAnimationFrame(f)}function P(){r=null,o=!1,h=null,d.on=!1,u.down=!1,u.id=-1,u.region=null,u.lastT=0,t.classList.remove("is-on"),t.setAttribute("aria-hidden","true")}function z(){o&&(v(),f())}return document.body.appendChild(t),{show:b,hide:P,tick:z,el:t}}var XM={piano:[{src:"assets/media/cutscene/enc_piano.jpg",hold:2800}],painter:[{src:"assets/media/cutscene/enc_painter.jpg",hold:2800}],incel:[{src:"assets/media/cutscene/enc_incel.jpg",hold:2800}],kid:[{src:"assets/media/cutscene/enc_kid.jpg",hold:2800}],babe:[{src:"assets/media/cutscene/enc_babe.jpg",hold:2800}],fight:[{src:"assets/media/cutscene/enc_fight.jpg",hold:2800}]};function qM(n,t){if(!n||!t)return 1/0;let e=n.x??n.position?.x,i=n.z??n.position?.z,s=t.x??t.position?.x,r=t.z??t.position?.z;if(e==null||s==null)return 1/0;let o=e-s,a=i-r;return o*o+a*a}function op(n){let t=new Set,e=!1,i=null;return{seen:t,tick(){if(e||!n.isPlaying()||n.reel.playing)return;let s=n.getPlayerPos();for(let r of n.spots){if(t.has(r.id))continue;let o=r.radius??5.5;if(qM(s,r.getPos())>o*o)continue;let a=XM[r.id];if(!a)continue;t.add(r.id),e=!0,i=r.id;let c=n.reel.onDone;n.reel.onDone=()=>{n.reel.onDone=c,e=!1;let l=i;i=null,n.onEnd?.(l)},n.onStart?.(r.id),n.reel.start(a);return}}}}var Ke=64,ap=256,YM=170,cp=.08,lp=1,va=.82,Ma=.6,up=16052196,ZM=8898799,hp=`
varying vec2 vUv;
void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`;function ln(n,t={}){return new Ht({color:n,roughness:.72,metalness:.04,...t})}function Br(n){return n.castShadow=!0,n.receiveShadow=!0,n}function li(n,t,e,i){return Br(new X(new Lt(n,t,e),i))}function Or(n,t,e=10,i=8){return Br(new X(new ne(n,e,i),t))}function qn(n,t,e,i,s=8){return Br(new X(new Nt(n,t,e,s),i))}function ql(n,t,{depth:e=!1,colorSpace:i=Be}={}){let s=new Un(n,t,{minFilter:ye,magFilter:ye,format:mn,type:En,depthBuffer:e,stencilBuffer:!1,generateMipmaps:!1});return s.texture.colorSpace=i,s.texture.flipY=!1,s}function JM(){let n=new dt,t=ln(8015402,{roughness:.9}),e=ln(4861462,{roughness:.88}),i=ln(up,{roughness:.96});for(let[l,h,u]of[[-.3,.14,.08],[.3,.14,-.08],[0,-.2,0]]){let d=li(.048,1.52,.048,t);d.position.set(l,.76,h),d.rotation.z=u,n.add(d)}let s=li(.72,.04,.16,e);s.position.set(0,.52,.1),n.add(s);let r=li(.7,.04,.04,t);r.position.set(0,1.46,.08),n.add(r);let o=li(va+.04,Ma+.04,.028,i);o.position.set(0,1.16,.11),o.rotation.x=-.1,n.add(o);let a=li(.03,.08,.03,e);a.position.set(-.34,.84,.12);let c=li(.03,.08,.03,e);return c.position.set(.34,.84,.12),n.add(a,c),{group:n,board:o}}function jM(){let n=new dt,t=ln(13213818,{roughness:.62}),e=ln(14207920,{roughness:.86}),i=ln(7035450,{roughness:.82}),s=ln(15260064,{roughness:.92}),r=ln(6967360,{roughness:.88}),o=li(.3,.48,.17,e);o.position.y=1.12,n.add(o);let a=li(.26,.14,.16,i);a.position.y=.84,n.add(a);let c=Or(.115,t,12,10);c.position.y=1.5,n.add(c);let l=Or(.12,r,10,8);l.position.set(0,1.53,-.01),l.scale.set(1.02,.72,1.04),n.add(l);let h=qn(.18,.18,.02,s,14);h.position.y=1.6;let u=qn(.11,.12,.08,s,12);u.position.y=1.65,n.add(h,u);let d=qn(.036,.04,.26,e);d.position.set(-.2,1.2,.02),d.rotation.z=.35;let p=qn(.03,.034,.22,t);p.position.set(-.28,1,.08),p.rotation.z=.55,p.rotation.x=-.4;let g=Or(.03,t,8,6);g.position.set(-.32,.9,.16),n.add(d,p,g);let x=Br(new X(new yr(.08,10),ln(13351062,{roughness:.7})));x.position.set(-.3,.88,.2),x.rotation.x=-1.15,x.rotation.z=.4,n.add(x);for(let[M,b,P]of[[-.025,.02,13123630],[.02,.025,3108762],[.015,-.02,13934615],[-.02,-.018,3832378]]){let z=new X(new yr(.016,6),ln(P,{roughness:.55}));z.position.set(-.3+M,.882,.2+b),z.rotation.copy(x.rotation),n.add(z)}let f=new dt;f.position.set(.18,1.34,.04);let m=Or(.042,e,8,6);f.add(m);let y=qn(.034,.038,.28,e);y.rotation.x=Math.PI/2,y.position.z=.14,f.add(y);let _=qn(.028,.032,.24,t);_.rotation.x=Math.PI/2,_.position.z=.38,f.add(_);let v=Or(.03,t,8,6);v.position.z=.52,f.add(v);let R=new dt,T=qn(.009,.011,.26,ln(5913114,{roughness:.7}),6);T.rotation.x=Math.PI/2,T.position.z=.13;let w=qn(.012,.012,.03,ln(11575408,{metalness:.45,roughness:.4}),6);w.rotation.x=Math.PI/2,w.position.z=.26;let U=Br(new X(new Ae(.016,.055,6),ln(3811864,{roughness:.9})));U.rotation.x=Math.PI/2,U.position.z=.3,R.add(T,w,U),R.position.z=.5,f.add(R),n.add(f);for(let M of[-1,1]){let b=qn(.048,.052,.28,i);b.position.set(M*.08,.64,0);let P=qn(.038,.046,.3,i);P.position.set(M*.08,.36,0);let z=li(.07,.04,.13,ln(3813416));z.position.set(M*.08,.02,.03),n.add(b,P,z)}return n.userData.arm=f,n.userData.brush=R,n.userData.paintTarget=!1,n.userData.kind="artist",n.userData.ageBand="adult",n}function QM(n){let t=-1,e=Ke>>1,i=Ke>>1,s=Ke*Ke;for(let r=0;r<s;r++){let o=r*4,a=n[o]*n[o]+n[o+1]*n[o+1]+n[o+2]*n[o+2];a>t&&(t=a,e=r%Ke,i=r/Ke|0)}return{u:(e+.5)/Ke,v:(i+.5)/Ke,err:t}}function dp(n,t={x:4.5,z:-6.2,yaw:-2.6}){let e=new dt;e.name="artist",e.position.set(t.x,0,t.z),e.rotation.y=t.yaw+Math.PI,e.userData.kind="artist",e.userData.ageBand="adult",e.userData.paintTarget=!1;let{group:i,board:s}=JM(),r=jM();r.position.set(-.4,0,.34),r.rotation.y=Math.PI+.32,e.add(i,r),n.add(e),e.updateMatrixWorld(!0);let o=ql(Ke,Ke,{depth:!0,colorSpace:Qt}),a=ql(ap,ap,{depth:!1,colorSpace:Qt}),c=ql(Ke,Ke,{depth:!1,colorSpace:Be}),l=new ae({map:a.texture,toneMapped:!1}),h=new X(new oe(va,Ma),l);h.position.copy(s.position),h.position.z+=.018,h.rotation.copy(s.rotation),h.layers.set(lp),h.layers.enable(0),s.layers.set(lp),s.layers.enable(0),i.add(h);let u=t.x+Math.sin(t.yaw)*14,d=t.z+Math.cos(t.yaw)*14,p=new Oe(42,va/Ma,.28,90),g=new L(0,1.54,.08);r.localToWorld(g),p.position.set(g.x+Math.sin(t.yaw)*.14,g.y,g.z+Math.cos(t.yaw)*.14),p.lookAt(u,1.15,d),p.layers.set(0),p.updateProjectionMatrix();let x=new Us(-1,1,1,-1,0,1),f=new bn({uniforms:{viewMap:{value:o.texture},paintMap:{value:a.texture}},vertexShader:hp,fragmentShader:$M,depthTest:!1,depthWrite:!1,toneMapped:!1}),m=new Wi;m.add(new X(new oe(2,2),f));let y=new bn({uniforms:{viewMap:{value:o.texture},center:{value:new lt(.5,.5)},radius:{value:cp},amount:{value:.7}},vertexShader:hp,fragmentShader:KM,transparent:!0,blending:_i,depthTest:!1,depthWrite:!1,toneMapped:!1}),_=new Wi;_.add(new X(new oe(2,2),y));let v=new Uint8Array(Ke*Ke*4),R=new Ut(up),T=new Ut(ZM),w=new Ut,U=new lt(.5,.5),M=new L,b=new L,P=new Ve,z=new Ve,F=r.userData.arm,C=r.userData.brush,D=!1,B=0,O=.5;function q(k,ot,Y,Q,ut){k.shadowMap.enabled=ut,k.autoClear=Y,k.setClearColor(w,Q),k.setRenderTarget(ot)}function W(k,ot){let Y=k.getRenderTarget(),Q=k.autoClear,ut=k.getClearAlpha(),bt=k.shadowMap.enabled;k.getClearColor(w),k.autoClear=!0,k.shadowMap.enabled=!1,D||(k.setRenderTarget(a),k.setClearColor(R,1),k.clear(),D=!0),h.visible=!1,s.visible=!1,k.setRenderTarget(o),k.setClearColor(T,1),k.render(ot,p),h.visible=!0,s.visible=!0,k.setRenderTarget(c),k.setClearColor(0,1),k.render(m,x),k.readRenderTargetPixels(c,0,0,Ke,Ke,v);let gt=QM(v);U.set(gt.u,gt.v),O=.62,y.uniforms.center.value.set(gt.u,gt.v),y.uniforms.radius.value=cp*(.72+Math.random()*.5),y.uniforms.amount.value=.58+Math.min(.36,gt.err/9e4),k.autoClear=!1,k.setRenderTarget(a),k.render(_,x),q(k,Y,Q,ut,bt)}function G(){M.set((U.x-.5)*va,(U.y-.5)*Ma,.02),h.localToWorld(b.copy(M)),P.copy(F.quaternion),F.lookAt(b),z.copy(F.quaternion),F.quaternion.copy(P).slerp(z,.2),O+=(.5-O)*.16,C.position.z=O}return{root:e,pose:t,tick(k,ot,Y){!/iP(hone|ad|od)/.test(navigator.userAgent)&&Y-B>=YM&&(W(k,ot),B=Y),G()}}}var tE=9131048,eE=12886122,nE=2889744;function es(n,t={}){return new Ht({color:n,roughness:.72,metalness:.04,...t})}function kn(n){return n.castShadow=!0,n.receiveShadow=!0,n}function iE(){let n=new dt,t=es(tE,{roughness:.62,metalness:.08}),e=es(eE,{roughness:.5}),i=es(nE,{roughness:.48}),s=kn(new X(new ne(.15,10,8),t));s.scale.set(1.05,1.22,.28),n.add(s);let r=kn(new X(new ne(.12,10,8),t));r.scale.set(.95,1.05,.28),r.position.set(0,-.12,0),n.add(r);let o=kn(new X(new Lt(.042,.48,.032),e));o.position.set(0,.4,0),n.add(o);let a=kn(new X(new Lt(.068,.1,.028),t));a.position.set(0,.68,0),n.add(a);let c=kn(new X(new Nt(.042,.042,.02,12),i));c.rotation.x=Math.PI/2,c.position.set(0,.02,.04),n.add(c);let l=kn(new X(new Lt(.08,.018,.016),i));return l.position.set(0,-.1,.038),n.add(l),n}function fp(n,t){let e=[];for(let r of[...n.children])t*r.position.x>.15&&r.position.y>.85&&e.push(r);let i=new dt;if(!e.length)return i;let s=e.reduce((r,o)=>r.position.y>=o.position.y?r:o);i.position.copy(s.position),n.add(i);for(let r of e)r.position.sub(i.position),i.add(r);return i}function pp(n,t,e,i,s){let r=nn(n);r.position.set(t,e,i),r.rotation.y=s;let o=iE();o.position.set(.08,.9,.2),o.rotation.set(.22,.12,1.05),r.add(o);let a=fp(r,1);a.rotation.set(-1.12,.08,-.52);let c=fp(r,-1);return c.rotation.set(-.98,-.06,.72),{mesh:r,guitar:o,strum:a,fret:c,yaw:s}}function sE(){let n=new dt,t=es(1710622,{roughness:.42,metalness:.35}),e=es(10133672,{roughness:.28,metalness:.65}),i=es(1118481,{roughness:.55,metalness:.4}),s=kn(new X(new Lt(.92,.42,.32),t));s.position.y=.22,n.add(s);for(let a of[-.26,.26]){let c=kn(new X(new Nt(.155,.155,.04,16),e));c.rotation.x=Math.PI/2,c.position.set(a,.22,.155),n.add(c);let l=kn(new X(new Nt(.08,.13,.03,14),i));l.rotation.x=Math.PI/2,l.position.set(a,.22,.175),n.add(l)}let r=kn(new X(new Si(.16,.016,6,12,Math.PI),e));r.rotation.set(0,0,Math.PI),r.position.set(0,.44,0),n.add(r);let o=kn(new X(new Lt(.22,.1,.02),es(2763312,{metalness:.25})));return o.position.set(0,.22,.165),n.add(o),n}function mp(n,t,e,i){let s=Fn(n);return s.position.set(t,0,e),s.rotation.y=i,{mesh:s,yaw:i,phase:t*.7+e*.4}}function gp(n){let t=new L(-6,0,5),e=new L(5,0,3),i=new L(12,0,8),s=pp({hair:16769162,shorts:936530,skin:14198126},t.x,0,t.z,.35),r=pp({hair:15783050,shorts:13123630,skin:13537112},e.x,0,e.z,-.4);s.mesh.name="ken-guitar-a",r.mesh.name="ken-guitar-b",n.add(s.mesh,r.mesh);let o=sE();o.position.copy(i),o.name="boombox",n.add(o);let a=mp({hair:1708560,bikini:16739226,skin:15251608},10.85,7.15,.55),c=mp({hair:15909166,bikini:3112912,skin:14262392},13.2,8.7,-.7);a.mesh.name="babe-boom-a",c.mesh.name="babe-boom-b",n.add(a.mesh,c.mesh);let l=[s,r],h=[a,c];return{tick(u){for(let d=0;d<l.length;d++){let p=l[d],g=Math.sin(u*8.2+d*1.7);p.strum.rotation.x=-1.12+g*.14,p.strum.rotation.z=-.52+g*.08,p.guitar.rotation.z=1.05+g*.035,p.guitar.rotation.x=.22+Math.abs(g)*.02,p.fret.rotation.z=.72+Math.sin(u*3.4+d)*.04,p.mesh.rotation.y=p.yaw+Math.sin(u*1.1+d)*.04}for(let d of h){let p=Math.sin(u*4.6+d.phase);d.mesh.position.y=Math.abs(p)*.14,d.mesh.rotation.z=Math.sin(u*2.3+d.phase)*.16,d.mesh.rotation.y=d.yaw+Math.sin(u*1.7+d.phase)*.28}},musicSpots:[{id:"guitar-a",position:s.mesh.position,radius:7},{id:"guitar-b",position:r.mesh.position,radius:7},{id:"boombox",position:o.position,radius:8},{id:"dj",position:new L(-24,0,7),radius:10}]}}var rE=16,oE=.15,aE=0,cE=4,Zl=.4,$l=.8,lE=2.2,qs=1/60,Yl=.984,xp=1,Sp=5,hE=4,uE={torso:new Lt(.34,.5,.18),head:new Lt(.22,.22,.22),arm:new Lt(.09,.5,.09),leg:new Lt(.11,.7,.11)},Xs=[{id:"torso",geo:"torso",ox:0,oy:1.16,oz:0,half:.25,inv:.35,mat:"skin"},{id:"head",geo:"head",ox:0,oy:1.62,oz:0,half:.11,inv:.85,mat:"skin"},{id:"armL",geo:"arm",ox:-.28,oy:1.2,oz:0,half:.25,inv:1,mat:"skin"},{id:"armR",geo:"arm",ox:.28,oy:1.2,oz:0,half:.25,inv:1,mat:"skin"},{id:"legL",geo:"leg",ox:-.09,oy:.36,oz:0,half:.35,inv:1,mat:"shorts"},{id:"legR",geo:"leg",ox:.09,oy:.36,oz:0,half:.35,inv:1,mat:"shorts"}],dE=Xs.slice(1).map(n=>({a:0,b:Xs.indexOf(n),rest:Math.hypot(n.ox-Xs[0].ox,n.oy-Xs[0].oy,n.oz-Xs[0].oz)})),_p=[{hair:16041009,shorts:2060152,skin:13934698},{hair:16739226,shorts:1723788,skin:13406042},{hair:16048762,shorts:14826299,skin:14721120},{hair:6211839,shorts:15909166,skin:13931082}],fE=[{x:16,z:2,axis:"x"},{x:-10,z:-3,axis:"z"}];function ns(n,t){return n+Math.random()*(t-n)}function yp(n){return new Ht({color:n,roughness:.72,metalness:.04})}function pE(n,t,e){let i=Math.cos(e),s=Math.sin(e);return{x:n*i-t*s,z:n*s+t*i}}function mE(n,t){return Math.atan2(t.x-n.x,t.z-n.z)}function gE(n,t){let e=yp(t.skin),i=yp(t.shorts),s=new dt;s.name="ken-ragdoll",s.visible=!1;let r=Xs.map(o=>{let a=o.mat==="shorts"?i:e,c=new X(uE[o.geo],a);return c.castShadow=!0,c.receiveShadow=!0,s.add(c),{mesh:c,x:0,y:o.oy,z:0,px:0,py:o.oy,pz:0,half:o.half,inv:o.inv,rx:0,rz:0,ox:o.ox,oy:o.oy,oz:o.oz}});return n.add(s),{root:s,parts:r}}function xE(n,t,e,i){let s=n.mesh.rotation.y,r=n.x,o=n.z;for(let a of n.doll.parts){let c=pE(a.ox,a.oz,s);a.x=r+c.x,a.y=a.oy,a.z=o+c.z;let l=t+ns(-1.4,1.4),h=e+ns(.4,2.2),u=i+ns(-1.4,1.4);a.px=a.x-l*qs,a.py=a.y-h*qs,a.pz=a.z-u*qs,a.rx=0,a.rz=0,a.mesh.position.set(a.x,a.y,a.z),a.mesh.rotation.set(0,s,0)}}function _E(n,t){let e=-rE*t*t;for(let i of n){let s=(i.x-i.px)*Yl,r=(i.y-i.py)*Yl,o=(i.z-i.pz)*Yl;i.px=i.x,i.py=i.y,i.pz=i.z,i.x+=s,i.y+=r+e,i.z+=o,i.rx+=o*10,i.rz-=s*10}}function yE(n){for(let t of dE){let e=n[t.a],i=n[t.b],s=i.x-e.x,r=i.y-e.y,o=i.z-e.z,a=Math.hypot(s,r,o)||1e-6,c=e.inv+i.inv,l=(a-t.rest)/a*(1/c);e.x+=s*l*e.inv,e.y+=r*l*e.inv,e.z+=o*l*e.inv,i.x-=s*l*i.inv,i.y-=r*l*i.inv,i.z-=o*l*i.inv}}function vE(n){for(let t of n){let e=aE+t.half;if(t.y>=e)continue;let i=t.x-t.px,s=t.y-t.py,r=t.z-t.pz;t.y=e,t.py=s<0?t.y+s*oE:t.y,t.px=t.x-i*.7,t.pz=t.z-r*.7}}function ME(n){for(let t of n.doll.parts)t.mesh.position.set(t.x,t.y,t.z),t.mesh.rotation.set(t.rx,n.mesh.rotation.y,t.rz)}function wp(n,t){n.state=t;let e=t==="ragdoll";n.mesh.visible=!e,n.doll.root.visible=e}function Kl(n,t=0){let e=n.mesh.userData.body;if(!e)return;let i=n.lead||1;e.armL.rotation.set(-1.22+(i<0?-t*.5:t*.1),.1,.48),e.armR.rotation.set(-1.22+(i>0?-t*.5:t*.1),-.1,-.48),e.legL.rotation.set(.1,0,.05),e.legR.rotation.set(.06,0,-.05)}function vp(n){n.x=n.home.x,n.z=n.home.z,n.vx=0,n.vz=0,n.hp=Sp+(Math.random()*3|0),n.cool=ns(Zl,$l),n.punch=0,n.acc=0,n.mesh.position.set(n.home.x,0,n.home.z),n.mesh.rotation.set(0,n.home.yaw,0),Kl(n,0),wp(n,"stand")}function EE(n,t,e,i){let s=3.2+i*2.4;xE(n,t*s,3.4+i*2,e*s),wp(n,"ragdoll")}function bE(n,t){let e=t.x-n.x,i=t.z-n.z,s=Math.hypot(e,i)||1,r=e/s,o=i/s,a=Math.random()<.14,c=a?1.35:ns(.7,1.05);if(n.vx+=r*1.6*c,n.vz+=o*1.6*c,n.punch=.16,t.state==="stand")t.vx+=r*2.8*c,t.vz+=o*2.8*c,t.hp-=a?xp*2:xp,t.hp<=0&&EE(t,r,o,c);else{let l=t.doll.parts[0];l.px-=r*.1*c,l.pz-=o*.1*c,l.py-=.03*c}}function Mp(n,t,e){n.cool-=e,n.cool<=0&&(n.cool=ns(Zl,$l),bE(n,t)),n.vx+=(n.home.x-n.x)*6*e,n.vz+=(n.home.z-n.z)*6*e,n.vx*=Math.max(0,1-5.5*e),n.vz*=Math.max(0,1-5.5*e),n.x+=n.vx*e,n.z+=n.vz*e,n.mesh.rotation.y=mE(n,t);let i=n.x,s=n.z,r=0;if(n.punch>0){n.punch=Math.max(0,n.punch-e),r=Math.sin((1-n.punch/.16)*Math.PI);let o=Math.sin(n.mesh.rotation.y),a=Math.cos(n.mesh.rotation.y);i+=o*r*.22,s+=a*r*.22}n.mesh.position.set(i,0,s),n.mesh.rotation.x=0,Kl(n,r)}function Ep(n,t){for(n.acc+=Math.min(t,.05);n.acc>=qs;){n.acc-=qs,_E(n.doll.parts,qs);for(let i=0;i<hE;i++)yE(n.doll.parts);vE(n.doll.parts)}ME(n);let e=n.doll.parts[0];n.x=e.x,n.z=e.z}function bp(n,t,e,i,s){let r=nn(s);r.position.set(t,0,e),r.rotation.y=i,r.userData.fight=!0,r.userData.paintTarget=!1,n.add(r);let o={mesh:r,doll:gE(n,s),home:{x:t,z:e,yaw:i},x:t,z:e,vx:0,vz:0,hp:Sp,cool:ns(Zl,$l),punch:0,acc:0,lead:Math.random()<.5?-1:1,state:"stand"};return Kl(o,0),o}function SE(n,t,e,i){let s=lE*.5,r=t.x,o=t.z,a=t.x,c=t.z,l=0,h=Math.PI;return t.axis==="x"?(r-=s,a+=s,l=Math.PI*.5,h=-Math.PI*.5):(o-=s,c+=s,l=0,h=Math.PI),{a:bp(n,r,o,l,e),b:bp(n,a,c,h,i),down:0}}function Tp(n){let t=fE.map((i,s)=>SE(n,i,_p[s*2],_p[s*2+1]));function e(i){if(!(i>0))return;let s=Math.min(i,.05);for(let r of t)r.a.state==="stand"&&Mp(r.a,r.b,s),r.b.state==="stand"&&Mp(r.b,r.a,s),r.a.state==="ragdoll"&&Ep(r.a,s),r.b.state==="ragdoll"&&Ep(r.b,s),(r.a.state==="ragdoll"||r.b.state==="ragdoll")&&(r.down+=s,r.down>=cE&&(vp(r.a),vp(r.b),r.down=0))}return{tick:e}}var Fr=5.5;var Ap={x:0,z:10},wE=[[-20,16],[0,12],[18,8],[8,-2],[-12,8]],Rp=["assets/media/psa/psa1.mp4","assets/media/psa/psa2.mp4","assets/media/psa/psa3.mp4","assets/media/psa/psa4.mp4","assets/media/psa/psa5.mp4"],Cp=["assets/media/cutscene/s4_i_can_use_them.jpg","assets/media/ads/billboard_terminate_uv.png","assets/media/ads/tv_surfclub.jpg","assets/media/ads/dj_slide_apply.jpg","assets/media/cutscene/aus101_ref.jpg"],TE=[["I CAN USE THEM","PUBLIC HEALTH REASSIGNMENT"],["TERMINATE UV","THE SUN IS A HOSTILE ACTOR"],["SURF CLUB NOTICE","ZINC ON \xB7 SHIRT OPTIONAL"],["APPLY","OR BE RECALLED"],["AUS101","DOES NOT TAKE REQUESTS"]];function AE(n,t){let e=document.createElement("canvas");e.width=512,e.height=384;let i=e.getContext("2d");i.fillStyle="#0b1210",i.fillRect(0,0,512,384),i.fillStyle="#1a3a28",i.fillRect(0,0,512,58),i.fillStyle="#c8a44a",i.fillRect(0,58,512,4),i.fillRect(0,380,512,4),i.fillStyle="#e8d48a",i.font="bold 18px Arial, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillText("DEPARTMENT OF WELLNESS",256,28),i.font="12px Arial, sans-serif",i.fillStyle="#9aaa88",i.fillText("GOLD COAST UNIT  \xB7  PSA",256,46),i.fillStyle="#f4f7fb",i.font="bold 42px Impact, Arial Black, sans-serif",i.fillText(n,256,188),i.fillStyle="#ffb040",i.font="bold 22px Arial, sans-serif",i.fillText(t,256,248),i.globalAlpha=.12,i.fillStyle="#000";for(let r=0;r<384;r+=3)i.fillRect(0,r,512,1);i.globalAlpha=1;let s=new rn(e);return s.colorSpace=Qt,s.needsUpdate=!0,s}function RE(n){let t=TE.map(([r,o])=>AE(r,o)),e=new ks,i=Cp.length,s=()=>{i-=1,i<=0&&n()};return Cp.forEach((r,o)=>{e.load(r,a=>{a.colorSpace=Qt,a.needsUpdate=!0,t[o]=a,s()},void 0,s)}),t}function CE(n,t,e,i){let s=new dt,r=ft(3817026,{metalness:.55,roughness:.42}),o=ft(1447962,{roughness:.62,metalness:.18}),a=ft(789518,{roughness:.5,metalness:.12}),c=new X(new Nt(.18,.22,.1,10),r);c.position.y=.05,c.castShadow=!0,s.add(c);let l=new X(new Nt(.05,.062,1.52,8),r);l.position.y=.86,l.castShadow=!0,s.add(l);let h=qt(.16,.08,.16,r);h.position.y=1.58,s.add(h);let u=qt(.78,.6,.26,o);u.position.y=1.78,s.add(u);let d=qt(.74,.52,.04,a);d.position.set(0,1.78,.14),s.add(d);let p=qt(.82,.07,.22,o);p.position.set(0,2.12,.06),s.add(p);let g=qt(.5,.08,.02,ft(2761748,{roughness:.7}));g.position.set(0,1.42,.14),s.add(g);let x=new X(new ne(.018,8,6),new Ht({color:3348480,emissive:16746496,emissiveIntensity:.12,roughness:.4}));x.position.set(.3,1.52,.15),s.add(x);let f=new Ht({map:i[e%i.length],emissive:16777215,emissiveMap:i[e%i.length],emissiveIntensity:.12,color:4868682,roughness:.38,metalness:.05}),m=new X(new oe(.42,.62),f);return m.position.set(0,1.82,.162),s.add(m),s.position.set(n,0,t),s.rotation.y=Math.atan2(Ap.x-n,Ap.z-t),{group:s,screenMat:f,ledMat:x.material,frame:e%i.length}}function Pp(n){let t=[],e=[],i=RE(()=>{for(let o of t){let a=i[o.frame];o.screenMat.map=a,o.screenMat.emissiveMap=a}});wE.forEach(([o,a],c)=>{let l=CE(o,a,c,i),h=document.createElement("video");h.src=Rp[c%Rp.length],h.loop=!0,h.muted=!0,h.playsInline=!0,h.preload="metadata",h.setAttribute("playsinline","");let u=new Os(h);u.colorSpace=Qt,l.video=h,l.videoTex=u,l.stillTex=i[c%i.length],n.add(l.group),t.push(l),e.push({position:new L(o,0,a),radius:Fr})});let s=new Ut(3815994),r=new Ut(16777215);return{spots:e,tick(o,a=!0){let c=performance.now(),l=-1,h=Fr*Fr;for(let u=0;u<t.length;u++){let d=e[u].position,p=(o.x-d.x)**2+(o.z-d.z)**2;p<h&&(h=p,l=u)}for(let u=0;u<t.length;u++){let d=t[u],p=e[u].position,g=o.x-p.x,x=o.z-p.z,f=g*g+x*x<Fr*Fr,m=d.screenMat,y=f?.92:.1;m.emissiveIntensity+=(y-m.emissiveIntensity)*.12,m.color.lerp(f?r:s,.12),d.ledMat.emissiveIntensity+=((f?1.4:.1)-d.ledMat.emissiveIntensity)*.14,f?(d.videoTex&&m.map!==d.videoTex&&(m.map=d.videoTex,m.emissiveMap=d.videoTex),d.video&&d.video.paused&&d.video.play().catch(()=>{}),d.video&&(d.video.muted=!a||u!==l,d.video.volume=.45)):d.video&&!d.video.paused&&(d.video.pause(),d.video.muted=!0,d.stillTex&&(m.map=d.stillTex,m.emissiveMap=d.stillTex))}}}}function PE(n,t){return Math.hypot(n.x-t.x,n.z-t.z)}function Lp({carpenter:n,shades:t,locals:e=[]}={}){let i=null;function s(){let a=new Set;n&&a.add(n),t&&a.add(t);for(let c of e)c?.bed&&a.add(c.bed);return a}function r(a){return a.id==="piano"||t&&a.bed===t?Math.max(a.radius??0,14):a.radius!=null?a.radius:0}function o(a){if(a===i)return;i=a;let c=s();if(a==="mute"){for(let h of c)h.setMix?.(0,.65);return}let l=n;a!=="carpenter"&&(l=e.find(u=>u.id===a)?.bed||n);for(let h of c)h.setMix?.(h===l?1:0,.65)}return{tick(a,c){if(!c||!a){o("mute");return}let l=null,h=1/0;for(let u of e){if(!u?.getPos||!u.bed)continue;let d=u.getPos();if(!d)continue;let p=PE(a,d);p<r(u)&&p<h&&(h=p,l=u)}o(l?l.id:"carpenter")}}}var Hn=n=>440*2**((n-69)/12);function Yn(n,t,e){let i=n.createOscillator();return i.type=t,i.frequency.value=e,i}function sn(n,t){let e=n.createGain();return e.gain.value=t,e}function ba(n,t,e,i){let s=n.createBiquadFilter();return s.type=t,s.frequency.value=e,i!=null&&(s.Q.value=i),s}function Jl(n,t,e,i){n.cancelScheduledValues(i),n.setValueAtTime(n.value,i),n.linearRampToValueAtTime(t,i+e)}function Ip(n,t){let e=Math.max(1,n.sampleRate*t|0),i=n.createBuffer(1,e,n.sampleRate),s=i.getChannelData(0);for(let r=0;r<e;r++)s[r]=Math.random()*2-1;return i}function kr(n,t,e,i,s){let r=sn(n,1e-4);return r.gain.setValueAtTime(1e-4,t),r.gain.exponentialRampToValueAtTime(e,t+i),r.gain.exponentialRampToValueAtTime(1e-4,t+s),r}function jl(n,t,e){let i=sn(n,0);i.connect(t||n.destination);let s=!1,r=0,o=0,a=0,c=0;return{out:i,get running(){return s},start(l){n.state==="suspended"&&n.resume(),!s&&(s=!0,a=0,o=n.currentTime+.06,Jl(i.gain,e*c,.08,n.currentTime),l())},setMix(l,h=.6){c=Math.max(0,Math.min(1,l)),Jl(i.gain,e*c,h,n.currentTime)},stop(){s=!1,clearTimeout(r),Jl(i.gain,0,.08,n.currentTime)},clock(l,h,u){if(!s)return;let d=n.currentTime+l;for(;o<d;)u(o,a++),o+=h;r=setTimeout(()=>this.clock(l,h,u),35)}}}function Dp(n,t,e,i=148,s=41,r=.72,o=.22){let a=Yn(n,"sine",i);a.frequency.setValueAtTime(i,e),a.frequency.exponentialRampToValueAtTime(s,e+.11);let c=kr(n,e,r,.004,o);a.connect(c).connect(t),a.start(e),a.stop(e+o+.02)}function Ea(n,t,e,i,s,r,o){let a=n.createBufferSource();a.buffer=e;let c=ba(n,"highpass",o,.7),l=kr(n,i,s,.002,r);a.connect(c).connect(l).connect(t),a.start(i),a.stop(i+r+.02)}function Up(n,t){let s=jl(n,t,.48),r=sn(n,1),o=sn(n,.7),a=sn(n,.45),c=sn(n,.28);r.connect(s.out),o.connect(s.out),a.connect(s.out),c.connect(s.out);let l=Ip(n,.06),h=Yn(n,"triangle",Hn(36)),u=ba(n,"lowpass",280,1.1),d=sn(n,1e-4);h.connect(d).connect(u).connect(a);let p=!1;function g(f,m){let y=Yn(n,"sine",Hn(m)),_=Yn(n,"sine",Hn(m+7));_.detune.value=4;let v=kr(n,f,.16,.01,.28);y.connect(v),_.connect(v),v.connect(c),y.start(f),y.stop(f+.3),_.start(f),_.stop(f+.3)}function x(f,m){let y=m&15;(y&3)===0&&Dp(n,r,f,142,40,.78,.2),Ea(n,o,l,f,y&1?.05:.14,y&1?.035:.048,7200),(y===6||y===14)&&Ea(n,o,l,f,.18,.16,4800);let v=Hn([36,36,39,43][y>>2&3]);h.frequency.setValueAtTime(v,f),d.gain.cancelScheduledValues(f),d.gain.setValueAtTime(1e-4,f),(y&3)===0&&(d.gain.exponentialRampToValueAtTime(.55,f+.012),d.gain.exponentialRampToValueAtTime(1e-4,f+.18)),(y===4||y===12)&&g(f,y===4?79:76),y===10&&g(f,72)}return{start(){p||(h.start(),p=!0),s.start(()=>s.clock(.12,15/118,x))},setMix:(f,m)=>s.setMix(f,m),stop:()=>s.stop()}}function Np(n,t){let i=[52,59,55,62,47,55,64,59,52,50,55,62],s=jl(n,t,.42),r=sn(n,.85),o=ba(n,"lowpass",2400,.6),a=n.createDelay(.45);a.delayTime.value=.28;let c=sn(n,.28);r.connect(o).connect(s.out),o.connect(a).connect(c).connect(a),a.connect(s.out);let l=Yn(n,"sine",Hn(40)),h=sn(n,.05);l.connect(h).connect(o);let u=!1;function d(g,x){let f=Yn(n,"sine",Hn(x)),m=Yn(n,"triangle",Hn(x));m.detune.value=6;let y=kr(n,g,.22,.012,1.8);if(f.connect(y),m.connect(y),y.connect(r),f.start(g),f.stop(g+1.9),m.start(g),m.stop(g+1.9),x>=55&&x&1){let _=Yn(n,"sine",Hn(x+7)),v=kr(n,g,.08,.02,1.4);_.connect(v).connect(r),_.start(g),_.stop(g+1.5)}}function p(g,x){d(g,i[x%i.length])}return{start(){u||(l.start(),u=!0),s.start(()=>s.clock(.2,.92,p))},setMix:(g,x)=>s.setMix(g,x),stop:()=>s.stop()}}function Op(n,t){let s=jl(n,t,.44),r=sn(n,.7),o=sn(n,.55),a=sn(n,.35);r.connect(s.out),o.connect(s.out),a.connect(s.out);let c=Ip(n,.04),l=Yn(n,"sawtooth",Hn(28)),h=Yn(n,"square",Hn(28));l.detune.value=3,h.detune.value=-5;let u=sn(n,.32),d=sn(n,1e-4),p=ba(n,"lowpass",520,1.8);l.connect(d),h.connect(u).connect(d),d.connect(p).connect(r);let g=!1;function x(f,m){let y=m>>3&7,_=m&7,v=Hn(y>=4?31:28);l.frequency.setValueAtTime(v,f),h.frequency.setValueAtTime(v*.997,f);let R=_&1;d.gain.cancelScheduledValues(f),d.gain.setValueAtTime(1e-4,f),d.gain.exponentialRampToValueAtTime(R?.12:.5,f+.01),d.gain.exponentialRampToValueAtTime(1e-4,f+(R?.06:.12)),R||(p.frequency.setValueAtTime(720,f),p.frequency.setTargetAtTime(480,f+.02,.05)),Ea(n,o,c,f,R?.07:.12,R?.03:.045,8e3),Ea(n,o,c,f+15/124,.045,.025,9e3),(_===2||_===6)&&Dp(n,a,f,210,90,.18,.06)}return{start(){g||(l.start(),h.start(),g=!0),s.start(()=>s.clock(.12,30/124,x))},setMix:(f,m)=>s.setMix(f,m),stop:()=>s.stop()}}var Bp=3,LE=4.8,IE=.62,Fp=8,Ys="assets/media/psa/",Hr="assets/media/ads/",DE=[`${Ys}psa1.mp4`,`${Ys}psa2.mp4`,`${Ys}psa3.mp4`,`${Ys}psa4.mp4`,`${Ys}psa5.mp4`,`${Hr}loop_apply.mp4`,`${Hr}loop_billboard.mp4`,`${Hr}loop_bunker.mp4`,`${Hr}loop_crt.mp4`],kp=[{brand:"BBL.TIPS",title:"Brazilian Butt Lift Tips",url:"bbl.tips/stairs",bg:"#1a0c12",bar:"#2a121c",accent:"#ff5a9a",ink:"#ffe6f0",dim:"#c898a8",rows:["3 flights or it didn't happen","Sit on a donut, not your career","Surgeon's IG vs your hallway"]},{brand:"CHEMTRAILS WEEKLY",title:"They lengthened the lines",url:"chemtrails.week/issue-408",bg:"#0b1520",bar:"#102030",accent:"#7ec8ff",ink:"#e8f4ff",dim:"#8aa8c0",rows:["Grid over the Gold Coast","Barium taste in the slushie","Unsubscribe is a psyop"]},{brand:"CLOUD//MART",title:"Vape Juice 40% Off",url:"cloudmart.au/juice",bg:"#120818",bar:"#1c1028",accent:"#c8ff3a",ink:"#f4ffe8",dim:"#a0b878",rows:["Mango-menthol 50mg","Free lung with 3 bottles","Not a cigarette, a lifestyle"]},{brand:"UNAPPROVED ZINC",title:"Unapproved Zinc Forum",url:"zinc.forum/unapproved",bg:"#14180e",bar:"#1c2212",accent:"#d4c070",ink:"#f2edd4",dim:"#9a9870",rows:["Is 50+ a psyop? (342)","White nose = class traitor","Sticky: council banned my tin"]},{brand:"CUBE KITCHEN",title:"Cockroach Cube Recipes",url:"cubekitchen.au/roast",bg:"#181208",bar:"#241c10",accent:"#e89030",ink:"#fff0d8",dim:"#c0a070",rows:["12-min roast, no questions","Stock from the tray water","Guest: crunch is the point"]}],UE=[{x:-17.4,z:10.7,yaw:.28,stripe:14703183},{x:-16.15,z:11.15,yaw:-.18,stripe:4166596}],Ql=new L,Hp=new L,Zp=new L(0,1,0),th=new Ve,zp=new Ve,Gp=new Ve,NE=new Ve().setFromAxisAngle(Zp,Math.PI),Vp=new Ee,OE=new Lt(.058,.112,.009),BE=new oe(.05,.098),FE=new Lt(.112,.154,.009),kE=new oe(.1,.138),HE=new Ht({color:1710622,roughness:.45,metalness:.38}),zE=new Ht({color:2236968,roughness:.4,metalness:.28}),Wp=new Ht({color:3816514,roughness:.38,metalness:.48}),GE=new Ht({color:1710622,roughness:.5,metalness:.22});function eh(n){return n.castShadow=!0,n.receiveShadow=!0,n}function $p(n){return new Ht({map:n,emissive:16777215,emissiveMap:n,emissiveIntensity:.48,color:16777215,roughness:.32,metalness:.04})}function Xp(n,t){n.map=t,n.emissiveMap=t,n.needsUpdate=!0}function qp(n,t,e){let i=document.createElement("canvas");i.width=t,i.height=e;let s=i.getContext("2d");s.fillStyle=n.bg,s.fillRect(0,0,t,e),s.fillStyle=n.bar,s.fillRect(0,0,t,e*.055),s.fillStyle=n.dim,s.font=`600 ${Math.round(e*.022)}px Arial, sans-serif`,s.textAlign="left",s.textBaseline="middle",s.fillText("9:41",t*.05,e*.028),s.textAlign="right",s.fillText("LTE   74%",t*.95,e*.028),s.fillStyle="#00000066";let r=e*.07,o=e*.048;s.fillRect(t*.08,r,t*.84,o),s.fillStyle=n.dim,s.font=`${Math.round(e*.02)}px Arial, sans-serif`,s.textAlign="center",s.fillText(n.url,t*.5,r+o*.55);let a=e*.14,c=e*.22;s.fillStyle=n.accent,s.fillRect(0,a,t,c),s.fillStyle=n.bar,s.globalAlpha=.18,s.fillRect(0,a+c*.62,t,c*.38),s.globalAlpha=1,s.fillStyle=n.bar,s.textAlign="left",s.font=`800 ${Math.round(e*.032)}px Impact, Arial Black, sans-serif`,s.fillText(n.brand,t*.06,a+e*.055),s.fillStyle=n.ink,s.font=`700 ${Math.round(e*.042)}px Arial, sans-serif`,s.fillText(n.title,t*.06,a+e*.125);let l=e*.4;for(let u of n.rows)s.fillStyle="#ffffff12",s.fillRect(t*.05,l,t*.9,e*.09),s.fillStyle=n.accent,s.fillRect(t*.05,l,6,e*.09),s.fillStyle=n.ink,s.font=`600 ${Math.round(e*.026)}px Arial, sans-serif`,s.fillText(u,t*.1,l+e*.052),l+=e*.105;s.globalAlpha=.1,s.fillStyle="#000";for(let u=0;u<e;u+=3)s.fillRect(0,u,t,1);s.globalAlpha=1;let h=new rn(i);return h.colorSpace=Qt,h.needsUpdate=!0,h}function VE(n){let t=document.createElement("canvas");t.width=128,t.height=256;let e=t.getContext("2d"),i=n>>16&255,s=n>>8&255,r=n&255;e.fillStyle=`rgb(${i},${s},${r})`,e.fillRect(0,0,128,256),e.fillStyle="rgba(255,255,255,0.22)";for(let a=0;a<10;a++)e.fillRect(0,a*26,128,10);e.fillStyle="rgba(0,0,0,0.12)",e.fillRect(0,0,128,8),e.fillRect(0,248,128,8);let o=new rn(t);return o.colorSpace=Qt,o.needsUpdate=!0,o}function WE(){return{portrait:kp.map(n=>qp(n,384,640)),landscape:kp.map(n=>qp(n,640,400))}}async function Yp(n,t=()=>!0){try{let e=await fetch(n);if(!e.ok)return[];let i=await e.text(),s=[],r=/href=["']([^"']+\.mp4)["']/gi,o;for(;o=r.exec(i);){let a=o[1].split("/").pop();t(a)&&s.push(n+a)}return s}catch{return[]}}function XE(n){return new Promise(t=>{let e=document.createElement("video");e.src=n,e.loop=!0,e.muted=!0,e.playsInline=!0,e.preload="auto",e.setAttribute("playsinline",""),e.setAttribute("muted","");let i=!1,s=r=>{i||(i=!0,t(r?e:null))};e.addEventListener("loadeddata",()=>s(!0),{once:!0}),e.addEventListener("error",()=>s(!1),{once:!0}),setTimeout(()=>s(e.readyState>=1),2200)})}async function qE(){let n=[...await Yp(Ys),...await Yp(Hr,r=>/^loop_.*\.mp4$/i.test(r))],t=[...new Set([...n,...DE])],i=(await Promise.all(t.map(XE))).filter(Boolean),s=[];for(let r of i){let o=new Os(r);o.colorSpace=Qt,o.minFilter=ye,o.magFilter=ye,o.generateMipmaps=!1,s.push({video:r,tex:o})}return s}function YE(n){let t=n?.mesh;return!t||typeof t.add!="function"||!t.children?.length||t.userData?.hasGadget||n.ageBand==="child"||n.ageBand==="gull"||n.kind==="gull"||n.kind==="kid"||t.name&&/guitar/i.test(t.name)?!1:n.ageBand==="adult"||n.kind==="ken"||n.kind==="babe"||n.kind==="sigma_07"||n.kind==="goth"}function ZE(n,t){let e=t<0?"armL":"armR",i=n.userData?.body;if(i){if(e==="armR"&&i.armR)return i.armR;if(e==="armL"&&i.armL)return i.armL;if(Array.isArray(i.arms)){let s=i.arms.find(r=>r?.name===e);if(s)return s}}return n.getObjectByName?.(e)||null}function $E(n){if(!n?.children?.length)return null;let t=n.getObjectByName?.("hand")||n.children.find(e=>/hand/i.test(e.name||""));if(t)return t;for(let e=n.children.length-1;e>=0;e--){let i=n.children[e];if(!i?.children?.length)continue;if(i.children.some(r=>/palm/i.test(r.name||"")||r.isMesh))return i}return null}function KE(n,t){let e=new dt,i=n==="tablet",s=eh(new X(i?FE:OE,i?zE:HE)),r=new X(i?kE:BE,$p(t));return r.position.z=i?.0052:.005,e.add(s,r),{group:e,screen:r,mat:r.material}}function JE(n,t,e,i){let s=n.mesh,{group:r,mat:o}=KE(t,e),a=ZE(s,i),c=$E(a);if(a&&c){a.rotation.x=-.95;let l=t==="tablet";r.position.set(0,l?-.08:-.07,l?.03:.026),r.rotation.set(0,0,0),c.add(r)}else{let l=s.userData?.body?.shoulderY||1.36;r.position.set(i*.16,l-.16,.2),r.rotation.set(-.95,i*.22,i*.08),s.add(r)}return s.userData.hasGadget=!0,{yawNode:r,mat:o,restQuat:r.quaternion.clone()}}function jE(n,t){let e=new dt,i=new X(new oe(1.12,2.15),new Ht({map:VE(n.stripe),roughness:.98,metalness:0}));i.rotation.x=-Math.PI/2,i.position.y=.018,i.receiveShadow=!0,e.add(i);let s=new dt,r=eh(new X(new Lt(.34,.014,.24),Wp));r.position.y=.01,s.add(r);let o=new X(new Lt(.3,.004,.16),GE);o.position.set(0,.018,.02),s.add(o);let a=new dt;a.position.set(0,.016,-.112),a.rotation.x=-.42;let c=eh(new X(new Lt(.34,.22,.01),Wp));c.position.set(0,.11,0);let l=new X(new oe(.3,.184),$p(t));return l.position.set(0,.11,.0065),a.add(c,l),s.add(a),s.position.set(0,.028,-.38),e.add(s),e.position.set(n.x,0,n.z),e.rotation.y=n.yaw,{group:e,laptop:s,mat:l.material,restQuat:s.quaternion.clone()}}function QE(n,t,e,i){if(i<.02){n.quaternion.copy(t);return}n.getWorldPosition(Ql),Hp.set(e.x,Ql.y+.15,e.z),Vp.lookAt(Ql,Hp,Zp),th.setFromRotationMatrix(Vp),th.multiply(NE),n.parent.getWorldQuaternion(zp),Gp.copy(zp).invert().multiply(th),n.quaternion.copy(t).slerp(Gp,i)}function tb(n,t,e,i){let s=e.x-n,r=e.z-t,o=s*s+r*r,a=i*i;return o>=a?{amt:0,d2:o}:{amt:(1-Math.sqrt(o)/i)*IE,d2:o}}function Kp(n,t){let e=WE(),i=[],s=-1,r=(n||[]).filter(YE);r.forEach((a,c)=>{let l=c%3===1?"tablet":"phone",h=c%2===0?1:-1,u=e.portrait[c%e.portrait.length],{yawNode:d,mat:p,restQuat:g}=JE(a,l,u,h);i.push({kind:l,yawNode:d,mat:p,restQuat:g,mesh:a.mesh,offset:c,usesVideo:!1,video:null,phase:c*.73,landscape:!1})}),UE.forEach((a,c)=>{let l=e.landscape[c%e.landscape.length],h=jE(a,l);t.add(h.group),i.push({kind:"laptop",yawNode:h.laptop,mat:h.mat,restQuat:h.restQuat,mesh:h.group,offset:r.length+c,usesVideo:!1,video:null,phase:2.1+c,landscape:!0})});let o=[];return qE().then(a=>{a.length&&(o.push(...a),i.forEach((c,l)=>{let h=a[l%a.length];Xp(c.mat,h.tex),c.usesVideo=!0,c.video=h.video}))}),{tick(a,c){if(!c)return;let l=Math.floor(a/Bp);if(l!==s){s=l;for(let u of i){if(u.usesVideo)continue;let d=u.landscape?e.landscape:e.portrait;Xp(u.mat,d[Math.floor(a/Bp+u.offset)%d.length])}}let h=new Set;for(let u of i){let d=u.mesh.position.x,p=u.mesh.position.z,{amt:g,d2:x}=tb(d,p,c,LE);QE(u.yawNode,u.restQuat,c,g),u.kind!=="laptop"&&u.yawNode.rotateX(Math.sin(a*1.6+u.phase)*.018);let f=.42+g*.7;u.mat.emissiveIntensity+=(f-u.mat.emissiveIntensity)*.12,u.video&&x<Fp*Fp&&h.add(u.video)}for(let u of o){let d=h.has(u.video);d&&u.video.paused?u.video.play().catch(()=>{}):!d&&!u.video.paused&&u.video.pause()}}}}var eb=2.6,Jp=["#e07040","#fbf6ea","#ffd76a","#2ec4c8","#7ad0ff","#9be07a","#ff7ab0"],nb=[3065032,8048895,10215546,16743088];function Rn(n,t={}){return new Ht({color:n,roughness:.72,metalness:.04,...t})}function t0(n){return n.castShadow=!0,n.receiveShadow=!0,n}function Zn(n,t,e,i){return t0(new X(new Lt(n,t,e),i))}function ib(n,t){return!n||!t?1/0:Math.hypot((n.x??0)-(t.x??0),(n.z??0)-(t.z??0))}function jp(n,t){let e=[];for(let r of[...n.children])t*r.position.x>.15&&r.position.y>.85&&e.push(r);let i=new dt;if(!e.length)return i;let s=e.reduce((r,o)=>r.position.y>=o.position.y?r:o);i.position.copy(s.position),n.add(i);for(let r of e)r.position.sub(i.position),i.add(r);return i}function Qp(n,t){let e=new dt,i=Zn(.086,.014,.054,n);e.add(i);let s=Zn(.07,.002,.028,t);return s.position.y=.008,e.add(s),e}function sb(){let n=new dt,t=Rn(1710624,{roughness:.4,metalness:.38}),e=Rn(13154458,{roughness:.55}),i=Rn(10133672,{roughness:.28,metalness:.62}),s=Rn(6964264,{roughness:.82}),r=Zn(.92,.42,.58,s);r.position.set(0,.21,.62),n.add(r);let o=Zn(.62,.07,.24,t);o.position.set(-.12,.46,.58),n.add(o);let a=Zn(.58,.008,.1,Rn(1118488,{roughness:.35,metalness:.2}));a.position.set(-.12,.5,.52),n.add(a);let c=[];for(let g=0;g<12;g++){let x=g%7===1||g%7===3||g%7===6,f=Zn(.038,.012,x?.07:.1,x?Rn(273):e);f.position.set(-.34+g*.042,.505,.64),n.add(f),c.push(f)}let l=Zn(.28,.06,.22,t);l.position.set(.28,.455,.6),n.add(l);let h=[];for(let g=0;g<2;g++)for(let x=0;x<4;x++){let f=Rn(2763314,{roughness:.45,emissive:0,emissiveIntensity:1}),m=Zn(.05,.012,.04,f);m.position.set(.175+x*.068,.492,.545+g*.07),n.add(m),h.push({mesh:m,mat:f})}let u=t0(new X(new Nt(.016,.016,.018,8),i));u.position.set(.12,.51,.5),n.add(u);let d=new dt,p=Zn(.2,.018,.16,Rn(273));p.position.y=.02,d.add(p);for(let g of[-1,1]){let x=Zn(.03,.06,.06,Rn(1710618,{metalness:.3}));x.position.set(g*.11,-.02,0),d.add(x)}return n.userData.cans=d,n.userData.keys=c,n.userData.pads=h,n}function Ci(n,t,e){let i=document.createElement(n);return t&&Object.assign(i.style,t),e&&e.appendChild(i),i}function rb(){if(typeof document>"u"||document.getElementById("aus101-seq-css"))return;let n=document.createElement("style");n.id="aus101-seq-css",n.textContent="#aus101-seq,#aus101-seq *{box-sizing:border-box;-webkit-tap-highlight-color:transparent}#aus101-seq{position:fixed;z-index:16;left:50%;bottom:max(18px,calc(env(safe-area-inset-bottom,0px) + 8px));transform:translateX(-50%);display:none;pointer-events:auto;padding:8px 8px 7px;background:rgba(11,18,16,.78);border:1px solid rgba(251,246,234,.22);border-radius:10px;box-shadow:0 8px 28px rgba(0,0,0,.35);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px)}#aus101-seq .grid{display:grid;grid-template-columns:10px repeat(16,14px);gap:3px;align-items:center}#aus101-seq .sw{width:8px;height:8px;border-radius:2px}#aus101-seq button.st{width:14px;height:14px;padding:0;margin:0;border:0;border-radius:2px;background:rgba(251,246,234,.12);cursor:pointer}#aus101-seq button.st[data-on='1']{background:var(--c,#ffd76a)}#aus101-seq button.st[data-now='1']{box-shadow:inset 0 0 0 1px #fff}#aus101-seq .row{display:flex;gap:6px;justify-content:flex-end;margin-top:6px}#aus101-seq .act{min-width:44px;height:22px;border:1px solid rgba(251,246,234,.28);border-radius:11px;background:rgba(12,18,16,.5);color:#fbf6ea;font:600 10px/1 system-ui,sans-serif;letter-spacing:.04em;padding:0 8px;cursor:pointer}#aus101-seq-pad{position:fixed;z-index:15;left:50%;bottom:max(20px,calc(env(safe-area-inset-bottom,0px) + 10px));transform:translateX(-50%);width:68px;height:68px;border-radius:50%;display:none;pointer-events:auto;background:rgba(12,18,16,.4);border:1px solid rgba(251,246,234,.28);box-shadow:0 4px 18px rgba(0,0,0,.28);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px)}#aus101-seq-pad:active{background:rgba(255,215,106,.28)}",document.head.appendChild(n)}function ob(n,t,e,i){rb();let s=document.getElementById("aus101-seq"),r=document.getElementById("aus101-seq-pad");if(s&&r)return{root:s,pad:r,cells:s._cells};s=Ci("div",null,document.body),s.id="aus101-seq";let o=Ci("div",null,s);o.className="grid";let a={};Vs.forEach((u,d)=>{let p=Ci("div",{background:Jp[d]},o);p.className="sw";let g=[];for(let x=0;x<16;x++){let f=Ci("button",null,o);f.className="st",f.type="button",f.style.setProperty("--c",Jp[d]),f.dataset.tr=u,f.dataset.s=String(x),g.push(f)}a[u]=g}),s._cells=a;let c=Ci("div",null,s);c.className="row";let l=Ci("button",null,c);l.className="act",l.type="button",l.textContent="SAVE";let h=Ci("button",null,c);return h.className="act",h.type="button",h.textContent="TAKE",l.addEventListener("pointerup",u=>{u.preventDefault(),u.stopPropagation(),t()}),h.addEventListener("pointerup",u=>{u.preventDefault(),u.stopPropagation(),e()}),o.addEventListener("pointerup",u=>{let d=u.target;!(d instanceof HTMLElement)||!d.classList.contains("st")||(u.preventDefault(),u.stopPropagation(),n(d.dataset.tr,parseInt(d.dataset.s,10)))}),r=Ci("div",null,document.body),r.id="aus101-seq-pad",r.addEventListener("pointerup",u=>{u.preventDefault(),u.stopPropagation(),i()}),{root:s,pad:r,cells:a}}function e0(n){let t=new dt;t.name="synth-rig",t.position.set(15.6,0,4.2),t.rotation.y=.35;let e=nn({hair:3809816,shorts:1710626,skin:13010498});e.name="synth-lad",e.userData.kind="ken",t.add(e);let i=sb();t.add(i);let s=i.userData.cans,{headY:r,headR:o}=e.userData.body;s.position.set(0,r+o*.15,0),e.add(s);let a=jp(e,-1),c=jp(e,1);a.rotation.set(-.92,-.04,.55),c.rotation.set(-.88,.06,-.62);let l=Rn(1447450,{roughness:.45,metalness:.2}),h=Rn(14708784,{roughness:.55});for(let P=0;P<3;P++){let z=Qp(l,h);z.position.set(.38-P*.02,.455+P*.015,.42),z.rotation.y=.2+P*.08,i.add(z)}let u=Qp(l,Rn(16766826,{roughness:.5}));u.position.set(-.34,.455,.44),u.visible=!1,i.add(u),n.add(t);let d=ff(),p=!1,g=null,x=!1,f=!1,m=!1,y=null;function _(){if(M)for(let P of Vs){let z=M.cells[P],F=d[P];for(let C=0;C<16;C++)z[C].dataset.on=F[C]?"1":"0"}}function v(P){if(!(!M||!p))for(let z of Vs){let F=M.cells[z];for(let C=0;C<16;C++)F[C].dataset.now=C===P?"1":"0"}}function R(){let P=qe();P&&(P.state==="suspended"&&P.resume(),y||(y=Pl(P,P.destination,d,{peak:.48})),y.start(),y.setMix(.4,.06))}function T(){y?.setMix(0,.08),y?.stop()}function w(P){P!==p&&(p=P,M&&(M.root.style.display=p?"block":"none",M.pad.style.display="none"),p?(document.exitPointerLock?.(),_(),R()):T())}function U(P){M&&(M.pad.style.display=P&&!p?"block":"none")}let M=typeof document<"u"?ob((P,z)=>{d[P]&&(d[P][z]=d[P][z]?0:1,_())},()=>{g="save",u.visible=!0},()=>{g="take",u.visible=!1},()=>{g="open",w(!0)}):null;typeof window<"u"&&window.addEventListener("keydown",P=>{P.code==="KeyE"&&qe()});function b(P,z){let F=ib(P,t.position)<=eb,C=!!z?.KeyE,D=!!(z?.Enter||z?.NumpadEnter),B=!!z?.KeyT,O=C&&!x,q=D&&!f,W=B&&!m;if(x=C,f=D,m=B,!F)return p&&w(!1),U(!1),g=null,null;U(!p);let G=null;return g&&(G=g,g=null),O?p?(w(!1),null):(w(!0),"open"):p&&q?(u.visible=!0,"save"):p&&W?(u.visible=!1,"take"):G==="open"?(w(!0),"open"):G==="save"||G==="take"?G:null}return{tick(P){let z=Math.sin(P*7.2);c.rotation.x=-.88+z*.1,a.rotation.z=.55+Math.sin(P*2.1)*.04,e.rotation.y=Math.sin(P*.7)*.05,e.userData.body?.head&&(e.userData.body.head.position.y=r+Math.sin(P*1.4)*.012);let F=y?.running?y.step:P*3.1&15,C=i.userData.pads;for(let B=0;B<C.length;B++){let O=p&&(F&7)===B;C[B].mat.emissive.setHex(O?nb[B%4]:0)}let D=i.userData.keys;for(let B=0;B<D.length;B++)D[B].position.y=.505+(p&&F%12===B?.006:0);p&&v(y?.step??0)},position:t.position,tryInteract:b,get pattern(){return d},snapshot(){return Cl(d)},get open(){return p}}}var ab=725520;yd();Ed();vd();var ah=document.getElementById("game"),ss=new gr({canvas:ah,antialias:!0,alpha:!1,powerPreference:"high-performance"});ss.setClearColor(ab,1);ss.outputColorSpace=Qt;ss.shadowMap.enabled=!0;ss.shadowMap.type=al;var hn=new Wi;Mf(hn);var Zs=new Oe(62,1,.08,220),cb=Gd(),s0=Od(),Ta=Ef(hn,s0),he=Nd({x:0,y:0,z:10});he.yaw=0;var $s=wf();hn.add($s);var Vr=yf(hn),Ra=gp(hn),lb=Tp(hn),hb=Pp(hn),r0=dp(hn),ub=Kp(Vr,hn),nh=e0(hn),Aa=pf({getBoomPos:()=>Ra.musicSpots.find(n=>n.id==="boombox")?.position||{x:12,z:8},getDjPos:()=>({x:-24,z:7})});for(let n of Ra.musicSpots)n.id.startsWith("guitar")&&n.position&&Vr.push({mesh:{position:n.position},kind:"ken",ageBand:"adult"});var yn=new aa;yn.loadManifest().catch(()=>{});var Ks=new ca,db=wd(Ks,null),fb=Dd(Ks),rh=Cf(yn,Vr),n0=Pf();kl($s);var o0=Jf();document.body.appendChild(o0.html);var pb=rp(),a0=Wf({scene:hn,play:n=>yn.play(n),onGameOver:()=>{Cn=!1,$n?.setState("menu")}}),c0=null;window.addEventListener("keydown",n=>{!Cn||Pn||n.code==="KeyF"&&(n.preventDefault(),a0.tryFire("laser"))});var $n=null,i0=null,zr=null,l0=null,Sa=null,Gr=null,wa=null,Cn=!1,Pn=!1,ih=0,h0=new ta(!1),is=Bd({dom:ah,isPlaying:()=>Cn&&!Pn,onEscapePause:()=>{Cn&&!Pn&&(Pn=!0,xb.showAsPause(),$n?.setState("menu"),document.pointerLockElement&&document.exitPointerLock())}});is.bindPlayer(he);$d({keys:is.keys,isPlaying:()=>Cn&&!Pn});function ch(){let{w:n,h:t}=Md(ss,ah);Zs.aspect=n/Math.max(1,t),Zs.updateProjectionMatrix()}ch();window.addEventListener("resize",ch);window.addEventListener("orientationchange",()=>setTimeout(ch,300));var Kn=!0;window.addEventListener("keydown",n=>{n.code==="KeyM"&&Cn&&(Kn=!Kn,yn.gain&&(yn.gain.gain.value=Kn?.5:0),Ks.master&&(Ks.master.gain.value=Kn?.85:0))});async function mb(){Cn=!0,Pn=!1,h0.start(),cb.snap(),is.tryLock();try{await yn.unlock(),await Ks.unlock();let n=yn.ctx||Ks.ctx;if(n&&!$n){$n=Td(n),i0=Ad(n),zr=jd(n),zr.start(),zr.setMix(0,.05),Sa=Up(n),Gr=Np(n),wa=Op(n),Sa.start(),Gr.start(),wa.start(),Sa.setMix(0,.05),Gr.setMix(0,.05),wa.setMix(0,.05);let t=Ra.musicSpots,e=i=>t.find(s=>s.id===i);c0=Qf({carpenter:$n,voice:yn,isTalking:i=>rh.isTalking(i??performance.now())}),l0=Lp({carpenter:$n,shades:zr,locals:[{id:"piano",getPos:()=>Ta.piano,radius:12,bed:zr},{id:"dj",getPos:()=>e("dj")?.position||{x:-24,z:7},radius:10,bed:wa},{id:"boombox",getPos:()=>e("boombox")?.position,radius:8,bed:Sa},{id:"guitar-a",getPos:()=>e("guitar-a")?.position,radius:7,bed:Gr},{id:"guitar-b",getPos:()=>e("guitar-b")?.position,radius:7,bed:Gr},{id:"tape",getPos:()=>Aa.currentBed.inserted==="dj"?{x:-24,z:7}:{x:12,z:8},radius:9,bed:Aa.currentBed}]})}$n?.setState("boardwalk"),$n?.start(),i0?.start(),Kn&&(yn.play("dj_open_01"),yn.preload(["gold_coast_lad_01","walkby_flirt_01","interject_oi_01","gull_01"]).catch(()=>{}))}catch(n){console.warn("audio",n)}}var oh=new oa({onDone:()=>mb()}),sh=n=>Vr.find(t=>t.kind===n)?.mesh?.position,gb=op({reel:oh,getPlayerPos:()=>he.pos,isPlaying:()=>Cn&&!Pn&&!oh.playing,spots:[{id:"piano",getPos:()=>Ta.piano,radius:8},{id:"painter",getPos:()=>r0.root?.position,radius:6},{id:"incel",getPos:()=>sh("sigma_07"),radius:5.5},{id:"kid",getPos:()=>sh("kid"),radius:5.2},{id:"babe",getPos:()=>sh("babe"),radius:5.5},{id:"fight",getPos:()=>({x:16,z:2}),radius:7}],onStart:()=>{Pn=!0,document.pointerLockElement&&document.exitPointerLock()},onEnd:()=>{Pn=!1,is.tryLock()}}),xb=new ra({onStart:()=>{yn.unlock().then(()=>{Kn&&yn.play("factory_recall_01")}).catch(()=>{}),oh.start()}}),_b=new ks().load("assets/media/ads/billboard_terminate_uv.png",n=>{n.colorSpace=Qt}),lh=new X(new oe(9.2,5.2),new ae({map:_b}));lh.position.set(0,6.4,zt.boardwalkZ-5.5);lh.rotation.y=Math.PI;hn.add(lh);function u0(){requestAnimationFrame(u0);let n=Pn||!Cn?0:Math.min(.05,h0.getDelta());for(ih+=n;ih>=On;){if(Cn&&!Pn){let t=Kd();t.mag>.04&&(he.yaw-=t.x*2.35*On,he.pitch-=t.y*1.55*On,he.pitch=Math.max(-1.45,Math.min(1.45,he.pitch))),Fd(he,is.keys,s0.COL,Ll,On)}ih-=On}if(Cn&&!Pn){let t=performance.now()*.001;Ta.update(t),Ra.tick(t),lb.tick(n||On),hb.tick(he.pos,Kn),ub.tick(t,he.pos),nh.tick(t);{let r=nh.tryInteract(he.pos,is.keys);(r==="save"||r==="take")&&Aa.saveFromSynth(nh.snapshot())}Aa.tick(he.pos),c0?.tick?.(),a0.tick(n||On,he.pos);let e=Math.hypot(he.vel.x,he.vel.z);$s.position.set(he.pos.x,he.pos.y,he.pos.z),$s.rotation.y=he.yaw+Math.PI,Il($s,{walkPhase:he.step,speed:e}),Vd(Zs,he,n||.016),db.tick(performance.now(),e>.4),fb.tick({speed:e,onWood:Ta.isWood(he.pos.x,he.pos.z),dt:n||On});let i=!!is.keys.Space;i?$n?.setState("apply"):$n?.setState("boardwalk");let s=kf({lotion:n0,cast:Vr,playerPos:he.pos,playerYaw:he.yaw,squeezing:i,dt:n||On,applyUx:pb,bay:o0});Hf($s,n0,n||On),s&&Kn&&!rh.isTalking(performance.now())&&Math.random()<.012&&yn.play("rub_pleasure_01",{gain:1.2}),Kn&&rh.tick(performance.now(),he.pos),l0?.tick(he.pos,Kn),r0.tick(ss,hn,performance.now()),gb.tick()}else Cn||(Zs.position.set(8,6.5,22),Zs.lookAt(0,1.2,4));ss.render(hn,Zs)}u0();
