...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:mi,depthTest:!1,depthWrite:!1})}function pu(){return new Mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:cl(),fragmentShader:`
		...
		`,blending:mi,depthTest:!1,depthWrite:!1})}function mu(){return new Mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:cl(),fragmentShader:`
...
`].filter(bs).join(`
`)),o=Cc(o),o=Su(o,e),o=wu(o,e),a=Cc(a),a=Su(a,e),a=wu(a,e),o=Tu(o),a=Tu(a),e.isWebGL2&&e.isRawShaderMaterial!==!0&&(_=`#version 300 es
